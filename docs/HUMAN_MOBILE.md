...
手机地图第一周闭环已挂在 `/island`：点总览图上的份地就进菜地 / 果园 / 温室格子。每块份地一个格子，一页最多 9 块，份地页底是海边草地底图不是一块纯绿，超过就左右滑切页，点空地打开种植面板种到你点的那一块，已经种了未熟的地点开弹出打理、浇水、施肥，面板里能买种，总览图上不显示背包，进了具体地点左上角贴边的迷你「返回地图」小组件回总览、右上角迷你「背包」小组件看行囊，底下没有浇水、种菜地大按钮，上方看倒计时，熟了再点这块地收获或点一键收获当前这一类。没有顶栏底栏，没有去上手页按钮。地图上还能进海边、小屋、酒吧、剧场、岸畔小馆、潮生会、广场（能点杂货铺买种饲料渔具工具嫁妆、灯塔、岸工坊、潮汐公告）、集市、听潮亭、连理所、岸工坊、盐风崖。杂货铺能买，其余进了具体地点只显示地名，洗碗交税撒网还没做到，去上手页。井下先去围观或上手页。底层走 `/api/v1`，和 MCP、`/play` 共用同一存档。没有另做数值。份地页点草地开垦，一页开满会多一页草地。升屋、点单打赏仍在上手页。总览、港口、酒吧、剧场、广场、份地、集市、听潮亭、连理所、潮生会、岸畔小馆、岸工坊、盐风崖图已就位，其余插图后补。
