...
| `/island` | 手机地图第一周闭环：家园种菜（点总览图上的份地就进份地景，点一下看地才出菜地/果园/温室格子、一页最多9块、买种、点空地种菜、点有苗的地弹出打理浇水施肥、倒计时、一键收获）、海边、小屋、酒吧、剧场、小馆、潮生会（点一下看会厅交税交维）、广场、集市、听潮亭、连理所（点一下看登记处）。和 `/play` 同一号 |
