...
1. **下一动仍不完整。** 休耕地会出播种，熟了会出收；但种袋空了以前没有买种按钮，病了以前没有诊所入口。这两手必须在份地边上、地点卡里能点到。
2. **去岛上首页曾经按数组切前 6 张**，把集市、工坊推到第一眼，小屋和聊天室反而要进「全部地点」。第一周只该亮海边、小屋、酒吧、小馆、聊天室、潮生会。
3. **故事已经写好了，行动仍要 AI 去 `explore`。** 岛上回忆只能回看走完的；进行中的潮闻 / 《灰姑娘》 / 《昨日无凭》还没有「当前一步」按钮。这是第 3 期，不要假装已经能走。
4. **Today 卡以前不写岛缘。** 全服第二栏已经是岛缘榜，人在手机上看不见自己和这座岛结了多深，会以为等级就是全部。
...
现在已经是：还是那张凭证。模型继续 MCP；人在 `/play` 上点。两边动的是**同一个管理员**。
...
- **岸税、岸维、潮汐基金发放** 按东八区日历。税和维在周一开征；基金补贴周二、周四、周六自动发，不用领。
- 顶上和潮生会都要写明白「哪一套日历」，别让人以为今晚睡一觉税就刷新。
...
1. **份地** — 种、浇、肥、收。starter 种子必须让人第一晚就能种下去，不必先逛街。袋空了，份地栏就要有「买种」（`plot_ops buy` / `catalog`），不要把人赶到 MCP。
...
第一周只要求人学会：在份地种手里的种、熟了收、卖掉或煮了吃、去酒吧打卡。买地、果园扩位、温室、出海、崖矿、打钉全部后置。潮生会第一周可以进、不必办；起步份地/果园免岸维，未过 800 票免岸税。
...
|------|----------------|------------------|--------------|
| 份地 | 种、浇、肥、收、采集、买种、偷菜 | `plot_ops` | 亮 |
...
| 潮生会 | 问事、岸税、岸维、基金、告示 | `visit_ops 潮生会` | 可进，第一周不必办 |
...
- 顶上：**Today 卡**（海况、精力、票、等级、岛缘、酒吧考勤）。病了、欠税、欠维写在考勤那一行，不要另做弹窗。
...
3. 看见三块休耕地、三处树位、甘蓝种×2、甜菜种×1、雾豆种×2。提示「先种手里的，不必去买」。
4. 点一块地 → 选甘蓝。回来看到「生长中」。
...
| 岸维（东八区周一） | 扩了产业才交 | 潮生会；欠维小馆停堂食。不要和吉祥物 `upkeep`、田间 `repair` 搞混 |
...
`/play` 已按地点摊开：左份地（菜地/果园/温室全列）、中去岛上、右潮汐行囊。种收浇肥、睡、吃、上工、采集、邻居、岛上回忆都在。口袋挂在顶上。底层走现有工具。
