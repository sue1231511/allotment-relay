...
岸税、岸维也不是第五条环。它们是日历上的岛务：岸税看口袋、周一划；岸维看产业、**每天划**，产业单价至少 10 票（超出份地/果园 10，开馆 12，小屋/船 10/15/20）。起步 3 块菜地 / 3 树位免。起步产业当天通常是 0，别做成新手打卡。**欠了才红点**，点进去是潮生会。
...
- 不要把岸维日单价擅自拆成 2。已经定过：每天收，产业单价至少 10（开馆 12，小屋/船 10/15/20）。
