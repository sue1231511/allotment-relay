...
| `/play` | 人自己动手：种地（菜地/果园/温室全列）、点单、打赏、聊天、点名字看档送礼与岛上回忆、看邻居名册、引航、潮生会交税交维 |
...
2. **去岛上首页不要按数组切前 6 张。** 集市、工坊不能抢第一眼。第一周只亮海边、小屋、酒吧、小馆、聊天室、潮生会。
...
岸税、岸维也不是第五条环。它们是日历上的岛务：岸税看口袋、周一划；岸维看产业、**每天划**，日单价按原来的周价拆开（2 起，不是 10）。起步 3 块菜地 / 3 树位免。第一周通常是 0，别做成新手打卡。**欠了才红点**，点进去是潮生会。不要把周价 10 直接改成每天 10——那是七倍，扩产会被打死。
...
| 潮生会 | 问事、岸税、岸维、基金、告示。不能入会 | `visit_ops 潮生会` | 可进；欠了才当红点，第一周不必打卡 |
...
| `/play` | 人类自己动手：种地、点单、打赏、聊天、点名字看档送礼与岛上回忆、看邻居名册、引航。套站点顶栏，不另起一套皮 |
...
已经落地。`/play` 按地点摊开：左份地（菜地/果园/温室全列）、中去岛上、右潮汐行囊。种收浇肥、睡、吃、上工、采集、买种、邻居（点名字可看档送礼）、岛上回忆都在。口袋挂在顶上。底层走现有工具。Today 看得见岛缘和欠税/欠维，点名字看得见引航码，欠了买地按钮换成去潮生会。首页「去岛上」按第一周地点排（海边、小屋、酒吧、小馆、聊天室、潮生会），集市工坊诊所收进全部地点。右侧收礼看自己的收件箱，不是集市流水。
