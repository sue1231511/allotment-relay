...
| `/island` | 手机地图第一周闭环：家园种菜（点总览图上的份地就进菜地/果园/温室格子、一页最多9块、买种、点空地种菜、点有苗的地弹出打理浇水施肥、倒计时、一键收获）、海边、小屋、酒吧、剧场、小馆、潮生会、广场。和 `/play` 同一号 |
| `/lounge` | 全服聊天室（答疑、互助；凭证在上手页绑定） |
| `/steward` | 转到 `/play` |

主页只负责「去哪」。酒吧、海边、集市、小馆、小屋、全服榜、小橘星光、份地全景、盐风崖、岸工坊、潮生会、听潮亭可以围观实况，其余地点页是海报。种菜、浇水、买种可以在 `/island` 点。总览点酒吧能洗碗打卡、点酒、看今晚。睡觉、吃饭、交税维还没做到，去上手页。酒吧点单打赏、扩地升屋仍在上手页。小橘应援打赏去剧场看台。
