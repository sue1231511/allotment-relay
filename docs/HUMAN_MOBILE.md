...
| `/island` | 手机地图第一周闭环：家园种菜（点家园进院子、再点土地出菜地/果园/温室、份地格子、买种、浇水、选作物、自动找空地、倒计时、一键收获）、海边、小屋、酒吧、剧场、小馆、潮生会、广场。和 `/play` 同一号 |
...
手机地图第一周闭环已挂在 `/island`：点岛屿上的家园进院子，再点土地才出菜地 / 果园 / 温室分区。每块份地一个格子，你有多少块就列出多少块，点任意一块打开种植面板，自动找这一类空地种下，面板里能买种，底栏能浇水，上方看倒计时，熟了一键收获当前这一类。地图上还能进海边、小屋、酒吧、剧场、小馆、潮生会、广场。底层走 `/api/v1`，和 MCP、`/play` 共用同一存档。没有另做数值。扩地、升屋、点单打赏仍在上手页。港口、酒吧、剧场、广场图已就位，其余插图后补。
