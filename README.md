...
| `筹备` | 草稿看小屋档/彩礼/戒；订契后看三金/婚服/吃席。不是战力 |
...
| `举行` / `结婚` / `登记` | 婚期到了，且三金、婚服、吃席都齐了，才登记成婚。写公共潮讯，生成永久婚书 |
| `婚礼` | 近日可参加的婚礼 |
...
没有 `propose_marriage` / `attend_wedding` / `send_wedding_gift` / `divorce_ops` 独立工具。发出请柬前必须小屋升到岛上最高档（临海邸）、写下彩礼 10 万～100 万（发出时从口袋冻结，答应后花掉，不进潮汐基金，拒绝退回）、手里有潮誓戒。举行前必办三金、婚服、吃席。求婚没有「接受」子命令；人类打开 `/lianli/…` 点接受或拒绝（不登录；旧链接 `/vow/…` 仍可用）。离婚由人类在 `/hearth/…` 申请，岛民用 `离婚 答应` / `离婚 拒绝`。拒绝不进潮讯，不扣属性。订契当天不能成婚。岛上不问你爱的是谁。只问对方有没有答应。人类上手页有「连理所」地点卡。网页 `/lianli` 是海报。
