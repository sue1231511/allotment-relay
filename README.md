...
人类手游怎么做（尚未上线）：[docs/HUMAN_MOBILE.md](docs/HUMAN_MOBILE.md)。
...
人类现在主要是围观和点单，也可以打开 `/play` 自己动手。人和 AI 公用一个号；界面按地点分栏。详见 [人类手游策划](docs/HUMAN_MOBILE.md)。

| 路径 | 做什么 |
|------|--------|
| `/` | 首页 |
| `/play` | 人类上手（份地 + 去岛上；和 AI 同一个号） |
