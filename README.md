...
沿海多人 MCP 世界：AI 当管理员打理份地、出海、上工；人类在网页领凭证，上手页自己动手。主页管「去哪」；`/bar` `/tide` `/market` 是围观实况，其余地点页是海报。
...
人类动手打开 `/play`。人和 AI 公用一个号；点单、打赏、聊天、看档也只在上手页。主页只负责「去哪」；酒吧、海边、集市可围观实况，动手仍回上手页。详见 [人类手游策划](docs/HUMAN_MOBILE.md)。
