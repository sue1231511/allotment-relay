...
| `/island` | 手机地图，进去后总览图铺满一屏，从小屋到井下都看得见；比一屏高就往下滚，底下不漏一块色。先贴凭证，点「进入地图」（上手页绑过会自己进；没反应换系统浏览器，不要停在微信里）。第一周能点：家园种菜（点总览图上的份地就进菜地 / 果园 / 温室格子；每块一份，一页最多 9 块、份地页底是海边草地底图不是一块纯绿、超过就左右滑切页；种植面板买种、左右选作物，白菜/胡萝卜/番茄对应甘蓝/甜菜/雾豌豆；点空地种菜；已经种了未熟的地，点开弹出海贝金边提示框，里面是打理、浇水、施肥；熟了再点这块地收获；底下没有浇水、种菜地大按钮；总览图上不显示背包；进了具体地点，左上角贴边的迷你「返回地图」小组件回总览，右上角迷你「背包」小组件看行囊；没有顶栏底栏，没有去上手页按钮，也没有回地图/浇水/种植白卡；一键收获；点草地开垦，一页开满会多一页草地）、港口（海边）、小屋、酒吧、剧场看台、岸畔小馆、潮生会、广场（图铺满一屏、底下不漏色；能点杂货铺买种饲料渔具工具嫁妆、灯塔、岸工坊、潮汐公告）、集市、听潮亭、连理所、岸工坊、盐风崖（杂货铺能买；其余进了具体地点只显示地名，没有洗碗、交税、撒网这些按钮，那些还没做到，去上手页）。井下先去围观或上手页。升屋、点单打赏仍去上手页。和 `/play` 同一张凭证、同一份存档 |
