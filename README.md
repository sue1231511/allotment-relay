...
| `潮生会 维` / `潮生会 维 交` / `维 交 50` | 岸维：产业维修费。起步 3 块份地、3 树位、棚屋 Lv1、第 1 口盐田、第 1 个矿坑免；超出份地 10/块、果园 10/树位、温室 10/座、畜栏 10+在栏 10/槽、开馆 12、小屋 Lv2/3/4 为 10/15/20、渔排 10/座、超出盐田 10/口、超出矿坑 10/坑、船 10/15/20。东八区每天换班自动划，不是岸税（岸税仍周一）。欠维修费同样不能扩产，开着的小馆暂停堂食。不是 `hut_ops mascot upkeep`（吉祥物喂养），也不是 `plot_ops repair`（田间意外）。没有 `upkeep_ops` |
