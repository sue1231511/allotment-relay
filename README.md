...
| `举行` / `结婚` / `登记` | 婚期到了，且三金、婚服、吃席都齐了，才登记成婚。订婚不是必须。写公共潮讯、灯塔亮灯、聊天室大厅通报一句（理枝），生成永久婚书 |
| `婚礼` | 近日可参加的婚礼 |
