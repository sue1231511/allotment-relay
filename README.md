...
| `/island` | 手机地图，进去后总览图和顶栏一样宽，按原图比例往下排，竖屏整张都看得见、不裁切；比一屏高就往下滚。先贴凭证，点「进入地图」（上手页绑过会自己进；没反应换系统浏览器，不要停在微信里）。第一周能点：家园种菜（点总览图上的份地就进菜地 / 果园 / 温室格子；每块一份，一页最多 9 块、超过就左右滑切页；种植面板买种、左右选作物，白菜/胡萝卜/番茄对应甘蓝/甜菜/雾豌豆；自动找空地；格子下面点「返回地图」、浇水或种菜，没有左下角图片小组件，也没有回地图/浇水/种植白卡；底栏只留背包，没有地图、任务、聊天页签，份地格子页连背包底栏也不出；一键收获）、海边撒网、小屋睡觉、酒吧洗碗、剧场看台、小馆/行囊吃饭、潮生会交岸税岸维、广场说话。总览图上的集市、工坊、崖、听潮亭、连理所、井下先去围观或上手页。扩地、升屋、点单打赏仍去上手页。和 `/play` 同一张凭证、同一份存档 |
