...
人类动手打开 `/play` 或 `/island`。人和 AI 公用一个号。点单、打赏、看档、邻居仍在上手页；手机地图第一周能点种浇收买种（点总览图上的份地就进菜地/果园/温室格子、一页最多9块、超过就左右滑切页、点空地种菜、点有苗的地弹出打理浇水施肥、倒计时、一键收获）。总览点酒吧，先进店景，点一下才出吧台列表，能洗碗打卡、点酒、看今晚。总览点剧场，进院景再点编剧社、衣泊坊、剧场看台。潮生会交税撒网还没做到，去上手页。主页只负责「去哪」；酒吧、海边、集市、小馆、小屋、全服榜、小橘星光、衣泊坊、份地全景、盐风崖、岸工坊、潮生会、听潮亭可围观，连理所是海报。给人类看的使用手册是 [`/manual`](docs/island-manual.md)；策划方向见 [人类手游策划](docs/HUMAN_MOBILE.md)。
