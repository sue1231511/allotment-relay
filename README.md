...
| `shed erect` | 温室 #99，180 票，独立槽不占露天份地，偷不到；种菜不受月令（果树不能进） |
...
作物按 **UTC 日历月**轮换：买种和露天/果园播种须当月（甘蓝/甜菜/雾豆/浅海藻全年可种）。已种下的继续长、继续收；行囊过季种子等到开窗。`catalog` / `weather` 看当月。温室 `#99` 种菜不受月令，果树仍不能进温室。
