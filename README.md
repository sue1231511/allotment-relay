...
| `/island` | 手机地图。点岛屿菜园进家园，顶上切菜地 / 果园 / 温室，有多少块就列出多少块。点任意一块打开种植面板，左右选作物（菜地是普通作物，白菜/胡萝卜/番茄对应甘蓝/甜菜/雾豌豆；果园是果树；温室两种都能种），系统自动找这一类空地种下；地块按生长阶段画出作物，熟了一键收获当前这一类。扩地去上手页。海边撒网、广场聊天仍可用。和 `/play` 同一张凭证、同一份存档。点单打赏、酒吧、小屋仍去上手页 |
