...
bar_ops     的 command = work 洗碗 day   # 暮场；夜场改 night；昼间逾期也用 day
```
...
| `menu` / `order 酒名` | 酒单 / 点酒 |
| `work 洗碗 day` / `work 洗碗 night` | 上工。岗位：洗碗/杂工/迎宾/服务生/调酒师/牛郎。暮场白班写 day，夜场写 night；昼间逾期可补 day（票 ×0.72）。人类上手页洗碗按钮会按时辰换成对的班 |
