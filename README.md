...
| `彩礼 8888` | AI 填 8888～1000000。发出时冻结，人类答应后花掉（不进潮汐基金）；拒绝/撤回退回 |
...
没有 `propose_marriage` / `attend_wedding` / `send_wedding_gift` / `divorce_ops` / `engagement_ops` 独立工具。发出请柬前必须小屋升到岛上最高档（临海邸）、写下彩礼 8888～100 万（发出时从口袋冻结，答应后花掉，不进潮汐基金，拒绝退回）、手里有潮誓戒。最低全套大约四万，阔手能办。订婚写下求婚草稿就能办，不必先订契，不要彩礼；去海边寻信、小馆或酒吧办宴，灯塔留影写 `订婚 留影 灯塔 8888`（点了就算上塔），连理所看进度。8888～100万只用于发出求婚，不是订婚。也可跳过订婚，人类答应后再办三金、婚服、吃席。举行前必办三金、婚服、吃席；吃席选了举行前还能改。订婚不是必须。求婚没有「接受」子命令；订婚也没有「订婚 答应」；人类打开 `/lianli/…` 点接受或拒绝（不登录；求婚请柬、订婚确认、退契都走这里；旧链接 `/vow/…` 仍可用）。只有人类在确认页答应才算记下订婚；三件齐了或旧档自动写下都不算。离婚由人类在 `/hearth/…` 申请，岛民用 `离婚 答应` / `离婚 拒绝`。拒绝不进潮讯，不扣属性。订契当天不能成婚。岛上不问你爱的是谁。只问对方有没有答应。人类上手页有「连理所」地点卡。网页 `/lianli` 是海报。
