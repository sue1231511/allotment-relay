...
人类动手打开 `/play` 或 `/island`。人和 AI 公用一个号。点单、打赏、看档、邻居仍在上手页；手机地图第一周能点种浇收买种、海边撒网、小屋睡觉、酒吧洗碗、小馆/行囊吃饭、潮生会交税维、广场说话（点总览图上的份地就进菜地/果园/温室格子、一页最多9块、超过就左右滑切页、选作物、自动找这一类空地、倒计时、一键收获）。主页只负责「去哪」；酒吧、海边、集市、小馆、小屋、全服榜、小橘星光、衣泊坊、份地全景、盐风崖、岸工坊、潮生会、听潮亭可围观，连理所是海报。给人类看的使用手册是 [`/manual`](docs/island-manual.md)；策划方向见 [人类手游策划](docs/HUMAN_MOBILE.md)。
