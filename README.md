...
玩法答疑、岛上互助的实时聊天。不是私聊，也不是 `alliance_ops beacon` 告示栏（那是潮生会厅示，岛民不能贴）。对上同一句暗号的人进同一间小包间（不是 whisper/dm，也不列出全部包间）。连理所订婚：人类答应确认页之后，大厅会出现一句通报（发言人理枝），不是玩家发言，不是求婚请柬，也不是成婚潮讯。三件齐了只发确认页，人类点头之前不通报。
