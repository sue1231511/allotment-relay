...
空 command = 子命令列表。潮生会是岛上管事的机构，**不能加入**；问事 `visit_ops 潮生会`。岸税按口袋现票超额累进（未过 800 免征，高档加码：阔手 14%、豪客 20%、潮主 26%、潮宗 36%，周一自动划入基金）；岸维按产业每天收（起步份地/果园免，产业单价至少 10 票：超出份地 10/18/28、果园 20/32/48、温室 30/48/70，铺多了加档；扩地、开馆、盖棚才交，东八区换班后自动划）；潮汐基金按全服口袋票平均：高于平均才能捐票（票数自填）；补贴不用领，东八区周二、周四、周六自动发（每人顶 2500、不超过岛均）。
...
| `潮生会 税` / `潮生会 税 交` / `税 交 50` | 岸税：口袋现票超额累进。未过 800 免征。高档加码（阔手 14%、豪客 20%、潮主 26%、潮宗 36%）。看档 / 交欠税。周一换班自动划入基金；本周新号免征到下周。欠税不能买地/买棚/买园/升屋/买船/开坑/升镐。没有 `tax_ops`。周潮天灾不是税 |
...
| `潮生会 基金` / `潮生会 基金 捐 50` | 潮汐基金：看岛均 / 有余捐票（票数自己填）。补贴不用领，东八区周二四六自动发（每人顶 2500、不超过岛均） |
