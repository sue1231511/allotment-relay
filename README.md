...
| `/island` | 手机地图，进去后铺满屏幕。先贴凭证，点「进入地图」（上手页绑过会自己进；没反应换系统浏览器，不要停在微信里）。第一周能点：家园种菜（点总览图上的份地进院子，再点土地才出菜地 / 果园 / 温室分区；每块份地一个格子；种植面板买种、左右选作物，白菜/胡萝卜/番茄对应甘蓝/甜菜/雾豌豆；自动找空地；底栏浇水；一键收获）、海边撒网、小屋睡觉、酒吧洗碗、剧场看台、小馆/行囊吃饭、潮生会交岸税岸维、广场说话。总览图上的集市、工坊、崖、听潮亭、连理所、井下先去围观或上手页。扩地、升屋、点单打赏仍去上手页。和 `/play` 同一张凭证、同一份存档 |
