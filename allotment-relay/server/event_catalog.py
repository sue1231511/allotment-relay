...
轻微/麻烦/危险/灾难方案名单在这里对齐；真正掴骰仍走各系统原模块。
"""
...
NAMED_EVENTS: tuple[dict[str, str], ...] = (
    ...
    {"key": "gull", "tier": tiers_mod.TIER_LIGHT, "name": "鸥啃浆", "mod": "farming"},
    ...
    {"key": "woodpecker", "tier": tiers_mod.TIER_LIGHT, "name": "啃木鸟", "mod": "farming"},
