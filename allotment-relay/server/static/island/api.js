...
export const api = {
  ...
  sow: (slot, crop, idem) => req(`/api/v1/farm/parcels/${slot}/sow`, { method: "POST", body: { crop }, idem }),
  water: (slot, idem) => req(`/api/v1/farm/parcels/${slot}/water`, { method: "POST", body: {}, idem }),
  harvest: (slot, idem) => req(`/api/v1/farm/parcels/${slot}/harvest`, { method: "POST", body: {}, idem }),
