...
export const api = {
  ...
  hearts: () => req("/api/v1/hearts"),
  heartOpen: (id) => req("/api/v1/hearts/open", { method: "POST", body: { id } }),
  heartKeep: (id) => req("/api/v1/hearts/keep", { method: "POST", body: { id } }),
  heartReply: (id, text) => req("/api/v1/hearts/reply", { method: "POST", body: { id, text } }),
  heartReturn: (body) => req("/api/v1/hearts/return", { method: "POST", body }),
