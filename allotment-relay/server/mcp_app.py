...
@mcp.tool(description="行囊、交换台、集市。command 写一整句。例子：list · gifts · vend 鲭鱼 1 · gift 安 甘蓝 1 · gift 安 票 5。gifts 查收到的礼。能直接送票，无手续费无每日上限。中文名或英文 id 都行。空 command 列出子命令。不会就 help。")
async def tote_ops(
    command: Annotated[str, Field(description="子命令整句。list / gifts / vend 鲭鱼 1 / gift 名字 甘蓝 1 / gift 名字 票 数量 / swap list / market list / help。gifts=收礼记录。能直接送票。不要发明 inventory/sell。")] = "",
) -> str:
