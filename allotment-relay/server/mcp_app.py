...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "潮生会是岛上管事的机构，不能加入；问事 visit_ops 潮生会。岸税 visit_ops 潮生会 税 / 税 交：口袋现票超额累进，未过 800 免征，周一换班自动划入基金；本周新号免征到下周；欠税不能买地/买棚/买园/升屋/买船/开坑/升镐。岸维 visit_ops 潮生会 维 / 维 交：按产业每周收（超出起步的份地 10 票/块、果园、温室、畜栏、开馆、小屋升级、渔排、盐田、矿坑、船），和岸税同一天划；欠维修费同样不能扩产，开着的小馆暂停堂食。不是 hut_ops mascot upkeep。潮汐基金按岛均口袋票：visit_ops 潮生会 基金 / 基金 捐 50（票数自填）；补贴不用领，东八区周二四六自动发。没有 tax_ops / upkeep_ops。周潮天灾不是税。steward_ops guild 是每日工分，不是入会。"
