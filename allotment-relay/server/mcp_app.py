...
async def marriage_ops(
    command: Annotated[str, Field(description="子命令整句。空=status 看自己的婚约。desk / 连理所=进门。求婚 阿潮（先写草稿） / 彩礼 188000 / 求婚 阿潮 | 誓言 | 信物 | 地点 | 今日+3 | 留言 / 发出 / 续请 / 撤回 / 筹备 / 寻戒 / 成戒 / 订婚 / 订婚 寻信 / 订婚 宴 小馆 12800 / 订婚 采花 / 订婚 信物 / 订婚 花束 / 金饰 / 婚服 / 吃席 滩席 / 吃席 岸席 自办 / 邀请 安 / 邀请 npc 阿簿 / 展示 潮闻 黑盒与潮声 / 举行 / 结婚 / 婚礼 / 出席 泊舟 / 祝词 泊舟 正文 / 送礼 泊舟 海玻璃 1 / 帮忙 泊舟 / 居所 登记 / 婚书 / 离婚 / 离婚 答应 / 离婚 拒绝 / 退契 确认 / help。发出前要小屋升到最高档（临海邸）、彩礼 10万～100万（答应后花掉，不进潮汐基金）、潮誓戒。订婚草稿就能办，不必先订契，不要彩礼（空 订婚=进度，订婚 寻信，订婚 宴 小馆 12800）。10万～100万只用于发出求婚。也可跳过订婚，人类答应后再备三金、婚服、吃席结婚。吃席选了举行前还能改，差价补上或退回口袋。宴席当场花掉，不进基金，订婚戒不是潮誓戒，订婚宴不是吃席。不要一次填六个数。订婚没有彩礼。求婚没有接受子命令。离婚由人类在婚书页申请，岛民 答应 或 拒绝。visit_ops 连理所 结婚 / 离婚 / 订婚 走同一套。不要发明 propose_marriage / divorce_ops / 离婚 确认 / engagement_ops。")] = "",
) -> str:
