...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "婚约：marriage_ops 求婚 人类昵称 | 誓言 | 信物 | 地点 | 今日+3。发出前：小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出时冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒。对象是自己的人类，不是岛民互婚。连理所（登记员理枝）办结婚离婚。人类不用注册。求婚打开确认页答应或拒绝；答应后可先订婚（可选，去海边寻信、小馆办宴；marriage_ops 订婚 看进度，订婚 礼金 18800，订婚 寻信；不要一次填六个数；当场花掉不进基金）再备三金、婚服、吃席，也可跳过订婚直接结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。求婚没有「接受」子命令，没有 propose_marriage / attend_wedding / divorce_ops 独立工具。拒绝不广播不惩罚。空 command=看自己的婚约档案。visit_ops 连理所 也能进门。"
