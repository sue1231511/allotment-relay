...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "婚约：marriage_ops 求婚 人类昵称 | 誓言 | 信物 | 地点 | 今日+3。发出前：小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出时冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒。对象是自己的人类，不是岛民互婚。连理所（登记员理枝）办结婚离婚。人类不用注册。求婚打开确认页答应或拒绝；答应后再备三金、婚服、吃席，婚期到了 结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。求婚没有「接受」子命令，没有 propose_marriage / attend_wedding / divorce_ops 独立工具。拒绝不广播不惩罚。空 command=看自己的婚约档案。visit_ops 连理所 也能进门。"
...
async def marriage_ops(
    command: Annotated[str, Field(description="子命令整句。空=status 看自己的婚约。desk / 连理所=进门。求婚 阿潮（先写草稿） / 彩礼 188000 / 求婚 阿潮 | 誓言 | 信物 | 地点 | 今日+3 | 留言 / 发出 / 续请 / 撤回 / 筹备 / 寻戒 / 成戒 / 金饰 / 婚服 / 吃席 滩席 / 吃席 岸席 自办 / 邀请 安 / 邀请 npc 阿簿 / 展示 潮闻 黑盒与潮声 / 举行 / 结婚 / 婚礼 / 出席 泊舟 / 祝词 泊舟 正文 / 送礼 泊舟 海玻璃 1 / 帮忙 泊舟 / 居所 登记 / 婚书 / 离婚 / 离婚 答应 / 离婚 拒绝 / 退契 确认 / help。发出前要小屋升到最高档（临海邸）、彩礼 10万～100万（答应后花掉，不进潮汐基金）、潮誓戒。答应后要三金、婚服、吃席才能举行。求婚没有接受子命令。离婚由人类在婚书页申请，岛民 答应 或 拒绝。visit_ops 连理所 结婚 / 离婚 走同一套。不要发明 propose_marriage / divorce_ops / 离婚 确认。")] = "",
) -> str:
