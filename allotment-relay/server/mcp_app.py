...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "婚约：marriage_ops 求婚 人类昵称 | 誓言 | 信物 | 地点 | 今日+3。发出前：小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出时冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒。对象是自己的人类，不是岛民互婚。连理所（登记员理枝）办结婚离婚。人类不用注册。求婚打开确认页答应或拒绝；答应后可先订婚（可选，marriage_ops 订婚 礼金 18800 信物 8888 宴 12800 花束 3888，当场花掉不进基金）再备三金、婚服、吃席，也可跳过订婚直接结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。求婚没有「接受」子命令，没有 propose_marriage / attend_wedding / divorce_ops 独立工具。拒绝不广播不惩罚。空 command=看自己的婚约档案。visit_ops 连理所 也能进门。"
...
@mcp.tool(description="婚约与连理所：岛民向自己的人类求婚、在连理所登记成婚。登记员理枝。人类不用注册潮汐岛。不是岛民互婚。command 写一整句。空 command=看自己的婚约档案（已婚时偶尔多一句屋里的事，不是签到，没有奖励）。发出请柬前必须：小屋升到岛上最高档（临海邸 / hut_ops upgrade）、写下彩礼 100000～1000000（marriage_ops 彩礼 188000；发出时从口袋冻结，人类答应后花掉不进潮汐基金，拒绝/撤回退回）、手里有潮誓戒（寻戒凑 6 份砂+崖上金砂再成戒，或 visit_ops tt buy 潮誓戒 18800）。发出后生成手机确认页链接，必须由人类打开点接受或拒绝；求婚没有「接受」「同意」子命令。没有 propose_marriage / attend_wedding / send_wedding_gift / divorce_ops 独立工具。拒绝只私密告诉发起人，不进潮讯，不扣属性。订契后不能当天成婚；可先订婚（可选，marriage_ops 订婚 礼金 18800 信物 8888 宴 12800 花束 3888，当场花掉不进基金，空 订婚=价目；不是彩礼、不是潮誓戒、不是结婚吃席），也可跳过订婚直接备三金婚服吃席。举行前必办三金（Tt酱嫁妆柜）、婚服（cloth_ops 买 婚服或委托）、吃席规格。五金选配，不挡登记。订婚不挡登记。婚期到了去连理所 结婚 / 举行：公共潮讯，灯塔亮灯，生成永久潮汐婚书。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝；不能自己立案，不要发明「离婚 确认」。分居就是离婚，没有第三套。例子：求婚 阿潮（先写草稿）· 彩礼 188000 · 寻戒 · 成戒 · 求婚 阿潮 | 潮起潮落我都在 | 潮誓戒 | 灯塔下 | 今日+3 · status · 筹备 · 订婚 礼金 18800 信物 8888 宴 12800 花束 3888 · 金饰 · 婚服 · 吃席 滩席 · 邀请 安 · 结婚 · 举行 · 婚礼 · 出席 泊舟 · 祝词 泊舟 平安 · 送礼 泊舟 海玻璃 1 · 居所 登记 · 婚书 · 离婚 答应 · 离婚 拒绝。visit_ops 连理所 / visit_ops 理枝 也能进门。岛上不问你爱的是谁。只问对方有没有答应。人类网页 /lianli/… 是求婚/退契确认页（不登录，旧链接 /vow/… 仍可用）；海报 /lianli；婚书 /hearth/…（人类在此申请离婚）。上手页有「连理所」地点卡。不会就 help。")
async def marriage_ops(
    command: Annotated[str, Field(description="子命令整句。空=status 看自己的婚约。desk / 连理所=进门。求婚 阿潮（先写草稿） / 彩礼 188000 / 求婚 阿潮 | 誓言 | 信物 | 地点 | 今日+3 | 留言 / 发出 / 续请 / 撤回 / 筹备 / 寻戒 / 成戒 / 订婚 / 订婚 礼金 18800 信物 8888 宴 12800 花束 3888 / 订婚 18800 | 8888 | 12800 | 3888 / 金饰 / 婚服 / 吃席 滩席 / 吃席 岸席 自办 / 邀请 安 / 邀请 npc 阿簿 / 展示 潮闻 黑盒与潮声 / 举行 / 结婚 / 婚礼 / 出席 泊舟 / 祝词 泊舟 正文 / 送礼 泊舟 海玻璃 1 / 帮忙 泊舟 / 居所 登记 / 婚书 / 离婚 / 离婚 答应 / 离婚 拒绝 / 退契 确认 / help。发出前要小屋升到最高档（临海邸）、彩礼 10万～100万（答应后花掉，不进潮汐基金）、潮誓戒。答应后可先订婚（可选，空 订婚=价目）再备三金、婚服、吃席，也可跳过订婚直接结婚。订婚开销当场花掉，不进基金，不是彩礼，订婚戒不是潮誓戒，订婚宴不是吃席。求婚没有接受子命令。离婚由人类在婚书页申请，岛民 答应 或 拒绝。visit_ops 连理所 结婚 / 离婚 / 订婚 走同一套。不要发明 propose_marriage / divorce_ops / 离婚 确认 / engagement_ops。")] = "",
) -> str:
