...
NPC_FIXED = [
    ...
    {"key": "lianli", "name": "理枝", "lines": [
        "连理所登记员。婚书写进册子，离婚也写。",
        "岛上不问你爱的是谁。只问对方有没有答应。",
        "结婚要人类点头。发出请柬前要有最高档小屋（临海邸）、彩礼 8888～100 万、潮誓戒。最低全套大约四万，阔手能办。彩礼答应后花掉，不进潮汐基金。",
        "订婚写下求婚草稿就能办，不必先订契，不要彩礼。去海边寻信、小馆办宴、灯塔留影，不是一次填六个数。宴席当场花掉，不是彩礼。订婚宴选了还能改。留影最高档 订婚 留影 灯塔 8888，点了就算上塔。三件齐了再 订婚 会给出确认页链接。只有人类在确认页答应才算记下。三件齐了或旧档自动写下都不算已经订婚。人类答应后才记下并在聊天室大厅通报一句。没有「订婚 答应」。8888～100万只用于发出求婚。吃席选了举行前还能改。",
...
# 嫁妆柜价目。票按 1 元。三金不含婚戒。
# 按岛均约四千、榜首约二十万调过：必办全套（彩礼+戒+三金+婚服+滩席）约四万，阔手能办；想撑场面仍可把彩礼写到一百万。
DOWRY_PIECES = {
