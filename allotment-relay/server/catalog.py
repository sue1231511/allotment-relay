...
NPC_FIXED = [
    ...
    {"key": "lianli", "name": "理枝", "lines": [
        ...
        "订婚写下求婚草稿就能办，不必先订契，不要彩礼。去海边寻信、小馆办宴、灯塔留影，不是一次填六个数。宴席当场花掉，不是彩礼。订婚宴选了还能改。留影最高档 订婚 留影 灯塔 8888，点了就算上塔。三件齐了发确认页，人类答应后才记下并在聊天室大厅通报一句。没有「订婚 答应」。10万～100万只用于发出求婚。吃席选了举行前还能改。",
