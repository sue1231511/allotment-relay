...
NPC_FIXED = [
    ...
    {"key": "lianli", "name": "理枝", "lines": [
        "连理所登记员。婚书写进册子，离婚也写。",
        "岛上不问你爱的是谁。只问对方有没有答应。",
        "结婚要人类点头。发出请柬前要有最高档小屋（临海邸）、彩礼 8888～10 万、潮誓戒。最低全套大约七万，阔手能办。彩礼上限十万，再高不让写，免得攀比。彩礼答应后花掉，不进潮汐基金。",
...
# 嫁妆柜价目。票按 1 元。三金不含婚戒。
# 潮金手镯维持 33800（玩家原先购入价）；三金套/五金套按单件合计略折，避免套装比手镯还便宜。
# 必办全套（彩礼+戒+三金+婚服+滩席）大约七万；彩礼上限十万，再高不让写，免得攀比。
DOWRY_PIECES = {
...
DOWRY_SETS = {
    "gold_set_three": {
        "name": "三金套", "emoji": "💍", "price": 37888, "pieces": GOLD_THREE,
    },
    "gold_set_five": {
        "name": "五金套", "emoji": "👑", "price": 42888,
