...
# months=可种的 UTC 日历月；缺省或空=全年。买种+露天/果园 sow 看当月；已种的继续长
...
CROPS = {
    ...
    "garlic":      {"name": "大蒜",     "emoji": "🧄", "seed_price": 9,  "sell": 18, "grow":  65, "yield": 5, "tier": 1, "spread": 0.22, "tags": ["seasoning"], "months": (11, 12, 1, 2)},
    "lemongrass":  {"name": "香茅",     "emoji": "🌿", "seed_price": 10, "sell": 20, "grow":  70, "yield": 5, "tier": 1, "spread": 0.22, "tags": ["seasoning", "tropic", "herb"], "months": (5, 6, 7, 8)},
    "chili":       {"name": "辣椒",     "emoji": "🌶️", "seed_price": 11, "sell": 22, "grow":  70, "yield": 5, "tier": 1, "spread": 0.24, "tags": ["seasoning"], "months": (4, 5, 6, 7, 8)},
    "sweetpotato": {"name": "红薯",     "emoji": "🍠", "seed_price": 8,  "sell": 17, "grow":  80, "yield": 5, "tier": 1, "spread": 0.24, "tags": ["root", "tropic"], "aliases": ["番薯", "地瓜"], "months": (6, 7, 8, 9, 10)},
    "ginger":      {"name": "姜",       "emoji": "🫚", "seed_price": 12, "sell": 24, "grow":  80, "yield": 5, "tier": 1, "spread": 0.22, "tags": ["seasoning", "tropic"], "months": (3, 4, 8, 9, 10)},
    # ── 中茬（约 1.5~2 时）──
    ...
    "rye":         {"name": "黑麦",     "emoji": "🌾", "seed_price": 8,  "sell": 19, "grow": 120, "yield": 4, "tier": 2, "spread": 0.28, "tags": ["grain"], "months": (10, 11, 12, 1, 2)},
    # ── 长茬（约 2.5~3 时）──
    "bramble":     {"name": "荆棘莓",   "emoji": "🫐", "seed_price": 14, "sell": 32, "grow": 150, "yield": 3, "tier": 3, "spread": 0.28, "tags": ["berry"], "months": (5, 6, 7, 8, 9)},
    "blueberry":   {"name": "蓝莓",     "emoji": "🫐", "seed_price": 16, "sell": 36, "grow": 160, "yield": 3, "tier": 3, "spread": 0.26, "tags": ["berry", "tropic"], "months": (4, 5, 6, 7)},
    ...
    # ── 稀有树（约 4.5~5 时）──
    "coconut":     {"name": "椰子",     "emoji": "🥥", "seed_price": 22, "sell": 24, "grow": 270, "yield": 2, "tier": 5, "spread": 0.20, "tags": ["fruit", "tropic"], "tree": True, "shake": True, "months": (6, 7, 8, 9)},
    "durian":      {"name": "榴莲",     "emoji": "🍈", "seed_price": 48, "sell": 95, "grow": 300, "yield": 2, "tier": 5, "spread": 0.20, "tags": ["fruit", "tropic"], "tree": True, "ultra_rare": True, "months": (6, 7, 8)},
}
