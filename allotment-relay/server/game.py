...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               人类 /island 总览点海边，进滩景再点港口、海边。港口点一下看码头，海边先进沙滩景，点一下才出人韶年，半身立绘对话，韶年站左边，只露上半身，先点对话框再出选项，点选项话写在对话框里，不另弹窗，能卜卦、转运、买符；要赶海再点去赶海，点一下看沙滩，能撒网、坐钓、赶海、开船。港口闲聊栏能说话，和上手页聊天室同一屋。围观 /tide 仍只看",
        "  tote_ops     行囊/交换台/集市",
        ...
        "  人类 /island 总览点海边，进滩景再点港口、海边。港口点一下看码头，海边先进沙滩景，点一下才出人韶年，半身立绘对话，韶年站左边，只露上半身，先点对话框再出选项，点选项话写在对话框里，不另弹窗，能卜卦、转运、买符；要赶海再点去赶海，点一下看沙滩，能撒网、坐钓、赶海、开船。港口闲聊栏能说话，和上手页聊天室同一屋；/tide 是围观实况",
        ...
        "  visit_ops list 看固定 NPC。tt 买种/饲料/渔具/锄铲/盐风镐。lili 流动摊（不在就 summon 献壳；人类 /island 广场点栗栗流动摊，点一下看摊）。韶年 fortune 卜卦；人类 /island 总览点海边，进滩景再点海边，先进沙滩景，点一下才出人韶年，半身立绘对话，韶年站左边，只露上半身，先点对话框再出选项，点选项话写在对话框里，不另弹窗；能卜卦、转运、买符，要赶海再点去赶海",
