...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "",
        "【人物故事探索 · 灰姑娘】",
        "  story_ops list — 查看故事；start cinderella 开始《灰姑娘》。空 command 与 list 相同",
        "  status 看剩余时间、已有证据/准备和当前可用行动；查看状态不耗时",
        ...
        "  archive 查看抵达的结局；start cinderella 可重置并重玩。不会就 help；没有 ask/question",
        "",
        "【逾篱摘取】",
