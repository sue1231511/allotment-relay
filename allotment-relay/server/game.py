...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "                 · musong visit · musong send 安 · musong remember · shaonian fortune · lore scan · clinic status",
        ...
        "               command 例：list · accept black_box_lover · accept memory_tide · status · explore beach · explore south_lane",
