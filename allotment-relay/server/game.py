...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               人类 /island 总览点海边，进滩景再点港口、海边。港口点一下看码头，海边点一下看沙滩，能撒网、坐钓、赶海、开船。围观 /tide 仍只看",
        "  tote_ops     行囊/交换台/集市",
        ...
        "  人类 /island 总览点海边，进滩景再点港口、海边。港口点一下看码头，海边点一下看沙滩，能撒网、坐钓、赶海、开船；/tide 是围观实况",
