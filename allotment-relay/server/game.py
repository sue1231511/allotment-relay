...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  票紧：暮场 bar_ops work 洗碗 day，夜场 work 洗碗 night；昼间逾期可补班 work 洗碗 day（票 ×0.72）。熟了再迎宾/服务生/调酒师。牛郎只夜班。",
        ...
        "               command 例：tonight · menu · order 酒名 · work 洗碗 day · work 洗碗 night · cheer 好话",
        ...
        "  · 岗位：洗碗/杂工/迎宾/服务生/调酒师/牛郎。班次写 day|night（或白班|夜班）。暮才有白班、夜才有夜班；昼间逾期可补白班。人类上手页洗碗按钮会按时辰换成对的班，不要写死 night",
        ...
        "  work 岗位 day|night 上工赚钱（也是考勤）。暮场写 day、夜场写 night；昼间逾期可补 day。人类上手页洗碗按钮按时辰上对的班",
        "  cheer 哄荔栀；她听不听她说了算",
