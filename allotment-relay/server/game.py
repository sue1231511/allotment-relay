...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               人类 /island 总览点海边，先进店景，点一下看出海，能撒网、坐钓、赶海、开船。围观 /tide 仍只看",
        "  tote_ops     行囊/交换台/集市",
        ...
        "  人类 /island 总览点海边，先进店景，点一下看出海，能撒网、坐钓、赶海、开船；/tide 是围观实况",
