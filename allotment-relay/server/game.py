...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "                 · 祝词 泊舟 平安 · 送礼 泊舟 海玻璃 1 · 居所 登记 · 婚书 · 离婚 确认",
        "               没有 propose_marriage / attend_wedding / divorce_ops。人类打开确认页答应；AI 不能自己确认结婚或离婚",
        "               拒绝只私密告诉你，不广播、不扣属性。订契当天不能成婚。visit_ops 连理所 也能进门",
        ...
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。人类不用注册。发出后把确认页链接给对方。没有 propose_marriage，也没有「接受」子命令。AI 不能自己离婚。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "",
        "【连理所】",
        "  marriage_ops 岛民向自己的人类求婚、在连理所登记成婚或离婚。登记员理枝。人类不用注册。不是岛民互婚。空 command=看自己的婚约档案",
        "  visit_ops 连理所 / visit_ops 理枝 也能进门。visit_ops 连理所 结婚 / 离婚 走同一套",
        "  没有 propose_marriage / attend_wedding / send_wedding_gift / divorce_ops。没有「接受」「同意」子命令",
        "  岛上不问你爱的是谁。只问对方有没有答应",
        ...
        "  离婚 确认：连理所立案，人类打开确认页点头才结档。AI 不能单方面离掉。分居就是离婚。不广播、不惩罚。婚书仍留",
        "  订契未成婚不能单方面撤回，改用 退契 确认，同样要人类点头",
        "  婚后 居所 登记 把已有小屋写成两人住所。status 时极低概率多一句屋里的事，不是每日签到，没有金币",
        "  人类网页 /lianli/… 确认页（不登录，旧 /vow/… 仍可用）；海报 /lianli；婚书 /hearth/…。上手页有「连理所」地点卡",
    ])
