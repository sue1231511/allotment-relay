...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "                 · 冰柜 存 甘蓝 3 · 冰柜 取 即兴好菜 · 潮柜 扩 · 堆肥桶 存 羊粪 3 · 卖掉 soft_1 确认",
        ...
        "                 · brew 材料 · store 菜名 · take 即兴好菜 · shop board · shop dine 安 · shop open 店名 · shop 卖掉",
        ...
        "    自由组合熟菜进冰箱后列表带中文名和 id：冰柜 取 即兴好菜 或 冰柜 取 那串 dish_mix_ id 都能取出",
        ...
        "  熟菜回精力 22 起比生吃划算得多。熟菜可 vend 或 hut_ops 冰柜 存 / kitchen_ops store；自由组合菜 fridge 列出中文名和 id，take 即兴好菜 也能取",
