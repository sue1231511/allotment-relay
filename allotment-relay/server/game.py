...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "                 · 发出 · 筹备 · 订婚 · 订婚 寻信 · 订婚 宴 小馆 12800 · 订婚 留影 灯塔 8888 · 金饰 · 婚服 · 吃席 滩席 / 潮宗席 · 邀请 安 · 结婚 · 举行 · 婚礼 · 出席 泊舟",
        "                 · 祝词 泊舟 平安 · 送礼 泊舟 海玻璃 1 · 贺礼 泊舟 500 · 纪念日 点灯 · 金饰 焕新 · 居所 登记 · 婚书 · 离婚 答应 · 离婚 拒绝",
        ...
        "  三金 visit_ops tt buy 三金套 → marriage_ops 金饰。婚服 cloth_ops 买 婚服 海色 或委托。吃席 滩席/岸席/灯塔席/满潮席/潮宗席（可自办；潮宗席 68888）。选了举行前还能改，差价补上或退回口袋",
        "  婚期到了 结婚 / 举行：在连理所登记成婚，公共潮讯、灯塔亮灯、聊天室大厅通报一句（理枝）、生成永久潮汐婚书。别人 出席 / 祝词 / 送礼 / 贺礼 500（88～88888 票，当场花掉记婚书）/ 帮忙",
        "  成婚之后每年一次：纪念日 点灯/续席/潮宗贺 · 金饰 焕新，记婚书，能抵锈",
