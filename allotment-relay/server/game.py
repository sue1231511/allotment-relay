...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。发出请柬前必须小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒（寻戒×6+金砂→成戒，或 tt buy 潮誓戒）。人类不用注册。没有 propose_marriage，求婚也没有「接受」子命令。订婚写下求婚草稿就能办，不必先订契，不要彩礼（marriage_ops 订婚 看进度，订婚 寻信，订婚 宴 小馆 12800，订婚 留影 灯塔 8888）。10万～100万只用于发出求婚，不是订婚门槛。也可跳过订婚，人类答应后再备三金、婚服、吃席结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "  订婚没有彩礼。没有礼金。订婚戒/信物不是潮誓戒，也不是求婚信物栏。订婚宴不是结婚吃席。订婚宴选了还能改，留影选了也能改，差价补上或退回口袋。服装和留影选配：衣泊坊买订婚服；留影最高档 订婚 留影 灯塔 8888（点了就算上塔，不用先 visit_ops），也可海边/小屋。灯塔席是结婚吃席，不是留影",
