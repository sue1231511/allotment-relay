...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               发出前：小屋升到最高档（临海邸）、彩礼 10万～100万（发出冻结，答应后花掉不进基金，拒绝退回）、潮誓戒。订婚写下求婚草稿就能办，不必先订契，不要彩礼（空 订婚=进度；订婚 寻信 · 订婚 宴 小馆）。10万～100万只用于发出求婚，不是订婚。答应后可跳过订婚直接备三金、婚服、吃席再结婚。举行前必办：三金、婚服、吃席。吃席选了举行前还能改。订婚戒不是潮誓戒，订婚宴不是吃席。不要一次填六个数。没有 propose_marriage。求婚没有「接受」子命令。离婚：人类在婚书页申请，岛民 离婚 答应 / 拒绝",
        ...
        "  订婚没有彩礼。没有礼金。订婚戒/信物不是潮誓戒，也不是求婚信物栏。订婚宴不是结婚吃席。订婚宴选了还能改，差价补上或退回口袋。服装和留影选配，去衣泊坊买订婚服、灯塔/海边/小屋留影",
