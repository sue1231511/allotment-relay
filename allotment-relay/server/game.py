...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "                 · clinic treat infection · clinic 调理 中 · clinic buy 回春汤 · clinic treat 腿鱼小咒 · visit 拾叶 · 漾漾 · 连理所 · 连理所 结婚 · 连理所 离婚",
        ...
        "                 · 发出 · 筹备 · 金饰 · 婚服 · 吃席 滩席 · 邀请 安 · 结婚 · 举行 · 婚礼 · 出席 泊舟",
        "                 · 祝词 泊舟 平安 · 送礼 泊舟 海玻璃 1 · 居所 登记 · 婚书 · 离婚 答应 · 离婚 拒绝",
        "               发出前：小屋升到最高档（临海邸）、彩礼 10万～100万（发出冻结，答应后花掉不进基金，拒绝退回）、潮誓戒。举行前：三金、婚服、吃席。没有 propose_marriage。求婚没有「接受」子命令。离婚：人类在婚书页申请，岛民 离婚 答应 / 拒绝",
        ...
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。发出请柬前必须小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒（寻戒×6+金砂→成戒，或 tt buy 潮誓戒）。人类不用注册。没有 propose_marriage，求婚也没有「接受」子命令。答应后再备三金、婚服、吃席，婚期到了 结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "  答应之后是已订契，不能当天成婚。三金 / 婚服 / 吃席 / 宾客 / 展示 等订契后再办，不是战力",
