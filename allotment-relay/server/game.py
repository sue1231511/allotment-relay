...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  steward_ops 灾档 — 未结案四档坏事件（崖/黑旗/杂务/井裂/份地·赶海 debuff）；鸟啄等瞬时事件记「近日已结」不占待处置",
        ...
        "  潮下炼制：undertide_ops 炼 list · 炼 brine_crystal · 炼 岸黑盐 · 炼 brine_nails · 炼 tide_black_salt（潮石+黑盐→双倍 proc_black_salt）",
