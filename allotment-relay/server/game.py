...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  票紧：bar_ops work 洗碗 就能上（班次可省略；暮白班、夜夜班）；熟了再迎宾/服务生/调酒师。牛郎只夜班。",
        ...
        "               command 例：tonight · menu · order 酒名 · work 洗碗 · cheer 好话",
        ...
        "  · 岗位：洗碗/杂工/迎宾/服务生/调酒师/牛郎。班次可省略（暮→白班、夜→夜班；逾期白天补班）。写明则 day|night（或白班|夜班）",
        ...
        "  work 岗位 [day|night] 上工赚钱（也是考勤；班次可省略）。cheer 哄荔栀；她听不听她说了算",
