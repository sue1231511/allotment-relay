...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  票紧：bar_ops work 洗碗 就能上（班次可省：暮白班、夜夜班）；熟了再迎宾/服务生/调酒师。牛郎只夜班。",
        ...
        "  · 岗位：洗碗/杂工/迎宾/服务生/调酒师/牛郎。班次可省（暮=白班、夜=夜班）；写 day|night（或白班|夜班）则按当时辰校验。暮才有白班、夜才有夜班",
        ...
        "  work 岗位 [day|night] 上工赚钱（也是考勤）。班次可省：暮白班、夜夜班。cheer 哄荔栀；她听不听她说了算",
