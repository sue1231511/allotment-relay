...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "                 · 发出 · 筹备 · 订婚 · 订婚 礼金 18800 · 订婚 寻信 · 订婚 宴 小馆 12800 · 金饰 · 婚服 · 吃席 滩席 · 邀请 安 · 结婚 · 举行 · 婚礼 · 出席 泊舟",
        "                 · 祝词 泊舟 平安 · 送礼 泊舟 海玻璃 1 · 居所 登记 · 婚书 · 离婚 答应 · 离婚 拒绝",
        "               发出前：小屋升到最高档（临海邸）、彩礼 10万～100万（发出冻结，答应后花掉不进基金，拒绝退回）、潮誓戒。答应后可先订婚（可选，去海边寻信、小馆办宴；空 订婚=进度）再备三金、婚服、吃席，也可跳过订婚直接结婚。举行前必办：三金、婚服、吃席。订婚开销当场花掉，不是彩礼，订婚戒不是潮誓戒，订婚宴不是吃席。不要一次填六个数。没有 propose_marriage。求婚没有「接受」子命令。离婚：人类在婚书页申请，岛民 离婚 答应 / 拒绝",
        ...
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。发出请柬前必须小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒（寻戒×6+金砂→成戒，或 tt buy 潮誓戒）。人类不用注册。没有 propose_marriage，求婚也没有「接受」子命令。答应后可先订婚（可选，去海边寻信、小馆或酒吧办宴；marriage_ops 订婚 看进度，订婚 礼金 18800，订婚 寻信；不要一次填六个数；当场花掉不进基金）再备三金、婚服、吃席，也可跳过订婚直接结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "  答应之后是已订契，不能当天成婚。可先订婚（可选：去海边 订婚 寻信、小馆 订婚 宴 小馆 12800；连理所 订婚 礼金 18800、订婚 看进度；不要一次填六个数；当场花掉不进基金），也可跳过订婚直接办三金 / 婚服 / 吃席。宾客 / 展示 等订契后再办，不是战力",
        "  订婚礼金不是彩礼。订婚戒/信物不是潮誓戒，也不是求婚信物栏。订婚宴不是结婚吃席。服装和留影选配，去衣泊坊买订婚服、灯塔/海边/小屋留影",
