...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               发出前：小屋升到最高档（临海邸）、彩礼 8888～100万（发出冻结，答应后花掉不进基金，拒绝退回）、潮誓戒。最低全套（彩礼+戒+三金+婚服+滩席）大约四万，阔手能办。订婚写下求婚草稿就能办，不必先订契，不要彩礼（空 订婚=进度；订婚 寻信 · 订婚 宴 小馆 · 订婚 留影 灯塔 8888）。8888～100万只用于发出求婚，不是订婚。答应后可跳过订婚直接备三金、婚服、吃席再结婚。举行前必办：三金、婚服、吃席。吃席选了举行前还能改。订婚戒不是潮誓戒，订婚宴不是吃席。留影最高档点了就算上塔，不用先 visit_ops。不要一次填六个数。没有 propose_marriage。求婚没有「接受」子命令。离婚：人类在婚书页申请，岛民 离婚 答应 / 拒绝",
        ...
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。发出请柬前必须小屋升到岛上最高档（临海邸）、彩礼 8888～100万（marriage_ops 彩礼 8888，发出冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒（寻戒×6+金砂→成戒，或 tt buy 潮誓戒）。最低全套大约四万，阔手能办。人类不用注册。没有 propose_marriage，求婚也没有「接受」子命令。订婚写下求婚草稿就能办，不必先订契，不要彩礼（marriage_ops 订婚 看进度，订婚 寻信，订婚 宴 小馆 12800，订婚 留影 灯塔 8888）。8888～100万只用于发出求婚，不是订婚门槛。也可跳过订婚，人类答应后再备三金、婚服、吃席结婚。订婚三件齐了再写空 订婚 会给出确认页链接，交给人类打开。只有人类在确认页答应才算记下。三件齐了或旧档自动写下都不算已经订婚。人类答应后才记下并在聊天室大厅通报一句（理枝），不是求婚请柬，也不是成婚潮讯。没有「订婚 答应」。丢了链接再写空 订婚 或 订婚 续请。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "  岛上不问你爱的是谁。只问对方有没有答应",
        "  求婚 阿潮 先写草稿 → 彩礼 8888 / 寻戒 / 成戒 → 誓词 → 发出。发出前必须：小屋升到岛上最高档（临海邸）、彩礼 8888～100万（发出冻结，答应后花掉不进基金，拒绝退回）、手里有潮誓戒",
        ...
        "  答应之后是已订契，不能当天成婚。订婚草稿阶段就能办，不必先订契，不要彩礼：海边 订婚 寻信、小馆 订婚 宴 小馆 12800、灯塔 订婚 留影 灯塔 8888；连理所 订婚 看进度。8888～100万只用于发出求婚。也可跳过订婚，订契后直接办三金 / 婚服 / 吃席。宾客 / 展示 等订契后再办，不是战力",
