...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               command 例：scan · say 有人知道温室怎么建吗 · 许愿 想加钓鱼大赛 · 反馈 按钮没反应 · 许愿墙 · 红包 100 5 · 抢 · 暗号 潮声今晚 · 大厅 · name 小明 · mod mute 名字 60 · help",
        ...
        "  · 聊天室许愿/反馈 = lounge_ops 许愿 / 反馈 / 许愿墙。全服可见，和 say 闲聊分开，不会刷走。不是听潮亭 wall_ops（长帖），也不是潮生会厅示",
