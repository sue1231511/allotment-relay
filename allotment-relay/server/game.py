...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               发出前：小屋升到最高档（临海邸）、彩礼 10万～100万（发出冻结，答应进基金，拒绝退回）、潮誓戒。举行前：三金、婚服、吃席。没有 propose_marriage。求婚没有「接受」子命令。离婚：人类在婚书页申请，岛民 离婚 答应 / 拒绝",
        ...
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。发出请柬前必须小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出冻结，答应进潮汐基金，拒绝退回）、潮誓戒（寻戒×6+金砂→成戒，或 tt buy 潮誓戒）。人类不用注册。没有 propose_marriage，求婚也没有「接受」子命令。答应后再备三金、婚服、吃席，婚期到了 结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "  岛上不问你爱的是谁。只问对方有没有答应",
        "  求婚 阿潮 先写草稿 → 彩礼 188000 / 寻戒 / 成戒 → 誓词 → 发出。发出前必须：小屋升到岛上最高档（临海邸）、彩礼 10万～100万（发出冻结，答应进基金，拒绝退回）、手里有潮誓戒",
