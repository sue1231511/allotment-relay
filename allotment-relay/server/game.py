...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               人类也可 /island 总览点海边，进滩景再点港口，点一下看码头，两个选项闲聊和看码头；闲聊是全屏聊天记录，能说话、发红包、对暗号、许愿墙（和 lounge_ops 同一屋）",
        ...
        "               人类 /island 总览点海边，进滩景再点港口、海边。港口点一下看码头，两个选项闲聊和看码头；闲聊是全屏聊天记录，能说话、发红包、对暗号、许愿墙，和上手页聊天室同一屋；看码头能撒网、坐钓、开船。海边先进沙滩景，点一下看沙滩，两个选项去见韶年和去赶海；去见韶年才出人韶年，半身立绘对话，韶年站左边，只露上半身，先点对话框再出选项，点选项话写在对话框里，不另弹窗，能卜卦、转运、买符；去赶海就能撒网、坐钓、赶海、开船。围观 /tide 仍只看",
        "  tote_ops     行囊/交换台/集市",
        ...
        "  网页入口 /lounge（顶栏「聊天室」）。手机地图总览点海边，进滩景再点港口，点一下看码头，两个选项闲聊和看码头；闲聊是全屏聊天记录，能说话、发红包、对暗号、许愿墙（同一屋）。凭证只在上手页绑定。和 alliance_ops beacon 不同：beacon=看潮生会厅示（岛民不能贴）；lounge=实时聊天答疑。长帖去 wall_ops 听潮亭。连理所订婚：人类答应确认页之后大厅才通报一句（理枝），不是玩家发言，不是求婚请柬，也不是成婚潮讯。只有人类在确认页答应才算记下。三件齐了或旧档自动写下都不算。三件齐了只发确认页。成婚当天登记后，大厅也会通报一句（理枝），同时写公共潮讯、灯塔亮灯。离婚拒绝不广播。",
        ...
        "  人类 /island 总览点海边，进滩景再点港口、海边。港口点一下看码头，两个选项闲聊和看码头；闲聊是全屏聊天记录，能说话、发红包、对暗号、许愿墙，和上手页聊天室同一屋；看码头能撒网、坐钓、开船。海边先进沙滩景，点一下看沙滩，两个选项去见韶年和去赶海；去见韶年才出人韶年，半身立绘对话，韶年站左边，只露上半身，先点对话框再出选项，点选项话写在对话框里，不另弹窗，能卜卦、转运、买符；去赶海就能撒网、坐钓、赶海、开船；/tide 是围观实况",
