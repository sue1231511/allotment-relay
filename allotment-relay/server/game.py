...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  · 潮生会是岛上管事的机构，不能入会/开会/退会。问事 visit_ops 潮生会。岸税 visit_ops 潮生会 税 / 税 交（应税家当超额累进：口袋+行囊/潮柜/冰箱/挂单囤货款按系统回收价估，未过 800 免征，高档加码：阔手 14%、豪客 20%、潮主 26%、潮宗 36%；离岛均太远加潮差：超过岛均 5 倍再加 8%，超过 15 倍再加 16%，刚到岛均的人加不到；只攒不花加潮锈：闲钱（超过岛均的部分）本周要花掉 15%，没花够的缺口整笔进基金，酒吧/小馆/衣泊坊/诊所/星光/小屋日子/婚宴/三金/基金捐算花，买地买园不算，买棚送礼也不算；周一换班自动划入基金，税仍从口袋划；本周新号免征到下周；欠税不能买地/买棚/买园/升屋/买船/开坑/升镐）。岸维 visit_ops 潮生会 维 / 维 交（按产业每天收：产业单价至少 10 票；超出起步的份地 10/18/28、果园 20/32/48、温室 30/48/70，铺多了加档；畜栏 10+在栏 10、开馆 12、小屋/船 10/15/20、渔排/盐田/矿坑 10；起步 3 块地和 3 树位免；欠维修费同样不能扩产，开着的小馆暂停堂食）。潮汐基金 visit_ops 潮生会 基金 / 基金 捐 50（票数自填，也算生活花销、能抵锈）。补贴不用领，东八区周二四六自动发（先托到 800，再按岛均补，每人顶 2500、不超过岛均）。本周目标/公仓/公物不在潮生会（alliance_ops league · donate · plot_ops commons）。steward_ops guild 是每日工分，不是入会。周潮天灾不是税。hut_ops mascot upkeep 是吉祥物喂养，不是岸维",
        ...
        "    岸税：visit_ops 潮生会 税 看档与档表；富人按应税家当超额累进交（口袋+囤货款按系统回收价估；未过 800 免征；高档加码：阔手 14%、豪客 20%、潮主 26%、潮宗 36%；离岛均太远加潮差：超过岛均 5 倍再加 8%，超过 15 倍再加 16%，刚到岛均的人加不到）。只攒不花加潮锈：闲钱（超过岛均的部分）本周要花掉 15%，没花够的缺口整笔进基金；酒吧/小馆/衣泊坊/诊所/星光/小屋日子/婚宴/三金/基金捐算花，买地买园不算，买棚送礼也不算。东八区每周一换班自动划入潮汐基金，税仍从口袋划；本周新号免征到下周。欠了 税 交（可 税 交 50）。欠税时不能买地/买棚/买园/升屋/买船/开坑/升镐。没有 tax_ops / upkeep_ops。周潮天灾（只冲 3 万以上）不是税",
