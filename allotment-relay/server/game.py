...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               command 例：scan · say 有人知道温室怎么建吗 · 暗号 潮声今晚 · 大厅 · name 小明 · mod mute 名字 60 · help",
        "               对上同一句暗号进同一间小包间（不是 whisper/dm，也不列出全部包间）。人类在 /lounge 或 /play 填暗号、点「对暗号」",
        ...
        "  小包间不是私聊/whisper：约好同一句暗号的人进同一间，大厅看不见。不列出全部包间。网页填暗号、点「对暗号」。",
