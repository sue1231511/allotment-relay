...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               command 例：list · accept black_box_lover · accept memory_tide · accept spring_beyond_mountain · accept missing_pages · status",
        "                 · explore beach · explore south_lane · explore shenzhi_home · explore cheng_home",
