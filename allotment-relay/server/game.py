...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  流程：买镐（48票，或 visit_ops tt buy 盐风镐）→ 探脉 → 挖 → 洗 原矿。精矿可 vend 或 升镐",
        "  涨潮盐脉肥、退潮铁砂床肥、海雾出潮纹/雾铅/夜光髓。镐档不够的稀有脉探得到、挖不动",
        "  探脉 4 精力、10 分钟冷却；挖 精力随镐 9→5、每坑 4 分钟冷却；洗 3 精力/份",
        "  开坑无上限：开坑 看价，开坑 确认 付钱（50/88/142…）。小屋盐风矿灯装上后挖少耗 1 精力",
        "  挥镐可能岩尘入肺：visit_ops clinic treat 岩尘入肺。酒吧考勤逾期同样锁崖矿",
        "  人类网页 /quarry 可围观谁在挥镐",
    ])
