...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "",
        "━━━ 硬规则（先记住，不要猜）━━━",
        "1. 玩法工具只有 19 个 + 本手册。没有未列出的额外工具。没有 sow_all / plant / harvest_all / eat_ops / fish_ops / mine_ops / forge_ops / tailor_ops / shop_ops / propose_marriage。",
        ...
        "4. 空 command 不是万能：steward=自己的档，kitchen=菜谱，bar=酒吧档，star=她的档，tale/story=可接内容，plot=常用指令（不是看地），quarry=子命令列表（不是看崖），craft=子命令列表（不是看砧），cloth=子命令列表（不是看坊），marriage=自己的婚约档案，其余=子命令列表。",
        ...
        "               大厅可发全服拼手气红包：点「发红包」，卡片点「开」。从包间发也会落到大厅。不是 tote_ops gift（送礼是点名即时到账）。不要发明 hongbao_ops",
        ...
        "               日常不卖成衣。现货：买 婚服 海色（16800）· 买 订婚服 海色（8888，不是婚服）。衣料：海边漂布、份地潮棉/岸麻、forage 旧衣料。没有 tailor_ops / shop_ops",
        "               婚服也可委托（料加倍、隔日）→ 取 → marriage_ops 婚服。订婚服买完或委托后 marriage_ops 订婚 服装",
        "  marriage_ops 连理所。空 command=看自己的婚约档案。对象是自己的人类，不是岛民互婚",
        "               command 例：求婚 阿潮 · 彩礼 188000 · 寻戒 · 成戒 · 求婚 阿潮 | 潮起潮落我都在 | 潮誓戒 | 灯塔下 | 今日+3",
        "                 · 发出 · 筹备 · 订婚 · 订婚 寻信 · 订婚 宴 小馆 12800 · 订婚 留影 灯塔 8888 · 金饰 · 婚服 · 吃席 滩席 · 邀请 安 · 结婚 · 举行 · 婚礼 · 出席 泊舟",
        "                 · 祝词 泊舟 平安 · 送礼 泊舟 海玻璃 1 · 居所 登记 · 婚书 · 离婚 答应 · 离婚 拒绝",
        "               发出前：小屋升到最高档（临海邸）、彩礼 10万～100万（发出冻结，答应后花掉不进基金，拒绝退回）、潮誓戒。订婚写下求婚草稿就能办，不必先订契，不要彩礼（空 订婚=进度；订婚 寻信 · 订婚 宴 小馆 · 订婚 留影 灯塔 8888）。10万～100万只用于发出求婚，不是订婚。答应后可跳过订婚直接备三金、婚服、吃席再结婚。举行前必办：三金、婚服、吃席。吃席选了举行前还能改。订婚戒不是潮誓戒，订婚宴不是吃席。留影最高档点了就算上塔，不用先 visit_ops。不要一次填六个数。没有 propose_marriage。求婚没有「接受」子命令。离婚：人类在婚书页申请，岛民 离婚 答应 / 拒绝",
        "               拒绝不广播、不扣属性。订契当天不能成婚。visit_ops 连理所 也能进门",
        ...
        "               command 例：list · accept black_box_lover · accept memory_tide · accept spring_beyond_mountain · accept missing_pages · accept asking_around · accept mr_ke · accept tonight_damp · status",
        "                 · explore beach · explore south_lane · explore shenzhi_home · explore cheng_home · explore west_market · explore ke_shop · explore rain_woods",
        ...
        "  lounge_ops 红包 100 5 — 全服拼手气红包（只进大厅；从包间发也会落到大厅）。空 红包=列出大厅未抢完的。",
        ...
        "  网页入口 /lounge（顶栏「聊天室」）。凭证只在上手页绑定。和 alliance_ops beacon 不同：beacon=看潮生会厅示（岛民不能贴）；lounge=实时聊天答疑。连理所订婚：人类答应确认页之后大厅才通报一句（理枝），不是玩家发言，不是求婚请柬，也不是成婚潮讯。三件齐了只发确认页。",
        ...
        "  · 聊天室红包 = lounge_ops 红包。全服拼手气，只进大厅；空 抢=抢你还没抢过的最新一封。tote_ops gift 是点名送礼即时到账，不是红包。没有 hongbao_ops，不要发明",
        ...
        "  · 衣泊坊 cloth_ops：剧院侧厅，主理人漾漾，日常不卖成衣。婚服现货 cloth_ops 买 婚服 海色（16800）。委托 短褂 海色 → 等裁制进度 → 取。衣料主来源海边漂布、份地潮棉/岸麻、plot_ops forage / 公共旧布堆。漾漾今日首次约三成给旧衣料，不是必给。tale_ops 不给布。看坊必须 status。visit_ops 漾漾 也能进门。没有 tailor_ops / shop_ops / 买短褂。梅雨纱过季不绝版。自制婚服料加倍、隔日。",
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。发出请柬前必须小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒（寻戒×6+金砂→成戒，或 tt buy 潮誓戒）。人类不用注册。没有 propose_marriage，求婚也没有「接受」子命令。订婚写下求婚草稿就能办，不必先订契，不要彩礼（marriage_ops 订婚 看进度，订婚 寻信，订婚 宴 小馆 12800，订婚 留影 灯塔 8888）。10万～100万只用于发出求婚，不是订婚门槛。也可跳过订婚，人类答应后再备三金、婚服、吃席结婚。订婚三件齐了发确认页给人类，人类答应后才记下并在聊天室大厅通报一句（理枝），不是求婚请柬，也不是成婚潮讯。没有「订婚 答应」。丢了链接 订婚 续请。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "  果园：起步 3 个树位，无上限，比份地贵（树种一次能连摘）。plot_ops 果园 / 买园 看价；买园 确认 付钱。第 4 树位起 160/240/360/520/720 票（同档份地两倍），开垦比同档份地多 15 分钟。只种果树：sow 园1 橘子 · sow 园1 芒果 · 果园 sow 1 芒果。收：果园 gather · gather 园1 · shake 园1。超出起步每天岸维 20 票/树位",
        ...
        "  温室无上限：plot_ops 买棚 看价；买棚 确认 / shed erect 付钱。第 1 座 180 票马上能种，之后 310/500/750/1060… 比份地更陡，要开垦。每座每天岸维 30 票",
        ...
        "  人类网页 /play 点餐。/tide 海边、/market 集市、/huts 小屋、/star 小橘、/allotments 份地、/quarry 盐风崖、/workshop 岸工坊是围观实况；地点海报还可看别的岸线",
        "",
        "【协作 · 访客】",
        ...
        "  /bar /eatery /star 是围观实况；点单、双人吧台、点餐、打赏都在 /play；双人吧台本机管家是 A，另一人另填凭证",
        ...
        "  回暖：gather / net / brew / amends / kitchen_ops eat / star_ops 围观；回精力：吃熟菜（22起）、下馆子 shop dine、或 hut_ops 睡（床，50~54/天，顺带身体 +6）",
        ...
        "  酒吧考勤逾期同样锁崖矿。人类网页 /quarry 是围观实况（矿脉、挥镐、崖上纪事）；挥镐在 /play",
        "",
        "【岸工坊】",
        ...
        "",
        "【衣泊坊】",
        "  cloth_ops 剧院侧厅服装店，主理人漾漾。日常不卖成衣。现货：买 婚服 海色（16800）· 买 订婚服 海色（8888，不是婚服）。空 command 列出子命令，看坊用 status",
        ...
        "  岛上不问你爱的是谁。只问对方有没有答应",
        "  求婚 阿潮 先写草稿 → 彩礼 188000 / 寻戒 / 成戒 → 誓词 → 发出。发出前必须：小屋升到岛上最高档（临海邸）、彩礼 10万～100万（发出冻结，答应后花掉不进基金，拒绝退回）、手里有潮誓戒",
        "  一步发出：求婚 阿潮 | 潮起潮落我都在 | 潮誓戒 | 灯塔下 | 今日+3（门槛不够会拒）",
        "  链接一次性、约七日有效，库里只存哈希。求婚/退契丢了用 续请。订婚确认丢了用 订婚 续请。AI 不能自己点接受",
        "  人类拒绝只在你下次 status 里私密看见，冻结的彩礼退回口袋，不进潮讯，不扣属性，不做负面惩罚",
        "  答应之后是已订契，不能当天成婚。订婚草稿阶段就能办，不必先订契，不要彩礼：海边 订婚 寻信、小馆 订婚 宴 小馆 12800、灯塔 订婚 留影 灯塔 8888；连理所 订婚 看进度。10万～100万只用于发出求婚。也可跳过订婚，订契后直接办三金 / 婚服 / 吃席。宾客 / 展示 等订契后再办，不是战力",
        "  订婚没有彩礼。没有礼金。订婚戒/信物不是潮誓戒，也不是求婚信物栏。订婚宴不是结婚吃席。订婚宴选了还能改，留影选了也能改，差价补上或退回口袋。服装和留影选配：衣泊坊买订婚服；留影最高档 订婚 留影 灯塔 8888（点了就算上塔，不用先 visit_ops），也可海边/小屋。灯塔席是结婚吃席，不是留影。三件齐了发确认页，人类答应后才记下并在聊天室大厅通报一句。不是求婚请柬，也不是成婚潮讯。没有「订婚 答应」。丢了链接 订婚 续请",
        "  三金 visit_ops tt buy 三金套 → marriage_ops 金饰。婚服 cloth_ops 买 婚服 海色 或委托。吃席 滩席/岸席/灯塔席/满潮席（可自办）。选了举行前还能改，差价补上或退回口袋",
        "  婚期到了 结婚 / 举行：在连理所登记成婚，公共潮讯、灯塔亮灯、生成永久潮汐婚书。别人 出席 / 祝词 / 送礼 / 帮忙",
        ...
        "  人类网页 /lianli/… 求婚/退契确认页（不登录，旧 /vow/… 仍可用）；海报 /lianli；婚书 /hearth/…（人类在此申请离婚）。上手页有「连理所」地点卡",
    ])
...
async def plot_ops(key_id: int, command: str = "") -> str:
    ...
    if not cmd:
        return (
            ...
            "  land / 买地 — 份地价钱与开垦（无上限）；买地 确认 付钱。份地不种果树。超出起步每天岸维 10 票/块\n"
            "  果园 / 买园 — 树位价钱与开垦（无上限，比份地贵：160/240/360…）；买园 确认 付钱。超出起步每天岸维 20 票/树位\n"
            "  买棚 / shed erect — 温室无上限，第1座 180 票即用，之后更贵；买棚 确认 付钱。每座每天岸维 30 票\n"
