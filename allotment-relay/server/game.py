...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  树（青柠/橘子/木瓜/香蕉/芒果/椰子/榴莲/柚子/柠檬/桃/橄榄/桑葚/咖啡/可可等）只种果园，按种苗成本有收茬上限，收满枯死；另有树龄，到了也会自然枯（勤收通常能收完茬，撂荒会先老死）。status 看「剩N茬」和「树龄N天/寿约D天」。橘子/椰子/柚子/柠檬等可 shake 园1。桃易虫害，樱桃鸟害重，葡萄连雨易烂，咖啡怕霜",
