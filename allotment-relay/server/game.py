...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               command 例：status · 图鉴 · 买 婚服 海色 · 委托 短褂 海色 · 委托 呢衣 墨色 灯塔 · 取 · 衣橱 · 穿 1 · 漾漾",
        "               日常不卖成衣。婚服现货：买 婚服 海色（16800）。衣料：海边漂布、份地潮棉/岸麻、forage 旧衣料。没有 tailor_ops / shop_ops",
        "               婚服也可委托（料加倍、隔日）→ 取 → marriage_ops 婚服 登记进婚礼",
        "  marriage_ops 连理所。空 command=看自己的婚约档案。对象是自己的人类，不是岛民互婚",
        "               command 例：求婚 阿潮 · 彩礼 188000 · 寻戒 · 成戒 · 求婚 阿潮 | 潮起潮落我都在 | 潮誓戒 | 灯塔下 | 今日+3",
        "                 · 发出 · 筹备 · 订婚 礼金 18800 信物 8888 宴 12800 花束 3888 · 金饰 · 婚服 · 吃席 滩席 · 邀请 安 · 结婚 · 举行 · 婚礼 · 出席 泊舟",
        "                 · 祝词 泊舟 平安 · 送礼 泊舟 海玻璃 1 · 居所 登记 · 婚书 · 离婚 答应 · 离婚 拒绝",
        "               发出前：小屋升到最高档（临海邸）、彩礼 10万～100万（发出冻结，答应后花掉不进基金，拒绝退回）、潮誓戒。答应后可先订婚（可选，空 订婚=价目）再备三金、婚服、吃席，也可跳过订婚直接结婚。举行前必办：三金、婚服、吃席。订婚开销当场花掉，不是彩礼，订婚戒不是潮誓戒，订婚宴不是吃席。没有 propose_marriage。求婚没有「接受」子命令。离婚：人类在婚书页申请，岛民 离婚 答应 / 拒绝",
        ...
        "               command 例：status · 打 铜钉 · 打 潮纹秤锤 · 打 铁锄刃 · 打 雾铅网坠 · 打 潮誓戒 · 取 · 灌 · 收盐 · 打捞 · 捐 亮壳一套 · 捐 砧上全套",
        ...
        "  · 婚约 / 连理所 marriage_ops：向自己的人类求婚，在连理所（登记员理枝）办结婚离婚。发出请柬前必须小屋升到岛上最高档（临海邸）、彩礼 10万～100万（marriage_ops 彩礼 188000，发出冻结，答应后花掉不进潮汐基金，拒绝退回）、潮誓戒（寻戒×6+金砂→成戒，或 tt buy 潮誓戒）。人类不用注册。没有 propose_marriage，求婚也没有「接受」子命令。答应后可先订婚（可选，marriage_ops 订婚 礼金 18800 信物 8888 宴 12800 花束 3888，当场花掉不进基金；空 订婚=价目）再备三金、婚服、吃席，也可跳过订婚直接结婚。离婚由人类在婚书页申请，岛民用 离婚 答应 / 离婚 拒绝。拒绝不广播、不惩罚。visit_ops 连理所 也能进门。岛上不问你爱的是谁。只问对方有没有答应。",
        ...
        "",
        "【衣泊坊】",
        "  cloth_ops 剧院侧厅服装店，主理人漾漾。日常不卖成衣。婚服现货：买 婚服 海色（16800）。空 command 列出子命令，看坊用 status",
        ...
        "  委托 短褂 海色 → 等裁制进度 → 取。也可 买 婚服 海色 · 委托 呢衣 墨色 灯塔 · 委托 婚服 海色 双潮（料加倍、隔日）。版型×颜色×纹样不同组合出不同衣服",
        ...
        "  答应之后是已订契，不能当天成婚。可先订婚（可选：订婚 礼金 18800 信物 8888 宴 12800 花束 3888，当场花掉不进基金；空 订婚=价目），也可跳过订婚直接办三金 / 婚服 / 吃席。宾客 / 展示 等订契后再办，不是战力",
        "  订婚礼金不是彩礼。订婚戒/信物开销不是潮誓戒，也不是求婚信物栏。订婚宴不是结婚吃席。服装和留影选配，不写或写 0 就跳过",
        "  三金 visit_ops tt buy 三金套 → marriage_ops 金饰。婚服 cloth_ops 买 婚服 海色 或委托。吃席 滩席/岸席/灯塔席/满潮席（可自办）",
