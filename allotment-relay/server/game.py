...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  人类网页 /play 点餐。地点海报：/tide 海边、/huts 小屋、/market 集市",
        "",
        "【协作 · 访客】",
        ...
        "  /bar /eatery /star 是地点海报。点单、双人吧台、点餐、打赏都在 /play；双人吧台本机管家是 A，另一人另填凭证",
        ...
        "  酒吧考勤逾期同样锁崖矿。人类网页 /quarry 是地点海报；挥镐在 /play。/tide 是海边海报",
        "",
        "【岸工坊】",
