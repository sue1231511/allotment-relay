...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "               人类网页 /steward 填凭证可查看状态与影信（本机会记住）",
        ...
        "               command 例：list · accept black_box_lover · accept memory_tide · accept spring_beyond_mountain · status",
        "                 · explore beach · explore south_lane · explore shenzhi_home",
        "                 · turnin · souvenirs · reminisce black_box_lover · board · help",
        ...
        "                 · inspect queen · prepare backdoor|broadcast|trap · choose escape|judgment|hunt|rescue · souvenirs · archive · help",
        "",
        "━━━ 全服聊天室 ━━━",
        ...
        "  reminisce black_box_lover — 通关后重读补充回忆；未通关不会提前显示",
        ...
        "  archive 查看全部人物故事结局；start 可重置并重玩，所有首次奖励不重复。不会就 help；没有 ask/question",
        "",
        "【逾篱摘取】",
        ...
        "  jingshan status 看下一步，remember 重读已获得的短探索记录；第一次见面不提前揭旧事，苏月琴不是单独 NPC",
        ...
        "  人类网页 /steward 填 ar_sk 凭证可查看管家状态与影信（本机浏览器会记住，可清除）",
