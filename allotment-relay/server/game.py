...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "",
        "工具一览（12 个。每个工具只有一个参数 command，把子命令整句写进去）：",
        "  空 command 走默认（steward=档案、kitchen=菜谱、bar=状态、star=她的档、plot=常用指令、其余=子命令列表）。help 列出子命令。中文名和英文 id 都能用。",
        ...
        "  star_ops — 小橘（女明星）。例子：status · 应援 好话 · 打赏 20 · 点歌 歌名 · 围观 · 粉丝团",
