...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "  票紧：bar_ops work 洗碗 就能上（班次可省，按暮/夜自动选；也可写 work 洗碗 night）。熟了再迎宾/服务生/调酒师。牛郎只夜班。",
        ...
        "  work 岗位 [day|night] 上工赚钱（也是考勤）。班次可省：暮自动白班、夜自动夜班；逾期白天补班 day ×0.72。cheer 哄荔栀；她听不听她说了算",
