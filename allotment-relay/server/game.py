...
async def relay_manual() -> str:
    return "\n".join([
        ...
        "                 · brew 材料 · store 菜名 · take 菜名 · shop board · shop dine 安 · shop open 店名 · shop 卖掉",
        ...
        "  冰箱列出中文名+英文 id；自由组合熟菜用中文名或 dish_mix_ id 取（同名取最早入柜的）",
        ...
        "  熟菜回精力 22 起比生吃划算得多。熟菜可 vend 或 hut_ops 冰柜 存 / kitchen_ops store；取出 kitchen_ops take 或 冰柜 取",
