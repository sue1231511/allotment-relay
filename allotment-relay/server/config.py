...
# 衣泊坊 — 剧院侧厅服装店。主理人漾漾。不卖成衣。
CLOTH_MATCH_SAVE = 1          # 当季合身：行动精力 -1（最低 1）
CLOTH_MISMATCH_COST = 1       # 盛夏穿呢衣 / 冬潮穿裙：行动精力 +1
CLOTH_STORY_EXTRA_SECONDS = 480
CLOTH_ECHO_TICKETS = 20
CLOTH_VISIT_OLD_CHANCE = 0.28
CLOTH_STAR_DYE_CHANCE = _event_rate(0.12)
CLOTH_LANTERN_DYE_CHANCE = _event_rate(0.14)
CLOTH_SEASON_DYE_CHANCE = _event_rate(0.10)
CLOTH_BEACH_DRIFT_CHANCE = 0.16
CLOTH_BEACH_SEASON_CHANCE = 0.38
