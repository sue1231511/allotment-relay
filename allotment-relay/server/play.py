...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "连理所",
        "kicker": "Lianli",
        "blurb": "岛上的登记处。发出请柬前：小屋升到最高档（临海邸）、彩礼 8888～100 万、潮誓戒。最低全套大约四万，阔手能办；想撑场面仍可把彩礼写高。订婚写下求婚草稿就能办，不必先订契，不用彩礼。发出请柬才要那笔彩礼。也可跳过订婚，人类答应后再办三金、婚服、吃席。连理所看进度、登记，信物去海边，宴去小馆或酒吧，最高档留影点「灯塔留影」。",
        "href": "/lianli",
        "live": "打开连理所海报 →",
        "rail": "今天在连理所办什么",
        "week1": False,
