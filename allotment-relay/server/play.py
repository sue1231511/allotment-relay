...
PLACES: list[dict[str, Any]] = [
    {
        ...
        "actions": [
            ...
            {"label": "翻沙", "note": "要铲子；涨潮关。订契后可能翻到潮信贝或潮花", "tool": "tide_ops", "command": "dig"},
            {"label": "寻信物", "note": "订契后在潮线找潮信贝，再去工坊打订婚戒或连理所登记", "tool": "marriage_ops", "command": "订婚 寻信"},
            {"label": "采花", "note": "订契后采潮花，拿去连理所登记花束", "tool": "marriage_ops", "command": "订婚 采花"},
            {"label": "海边留影", "note": "订契后选配。先寻信、采花或赶海，再在这儿留影", "tool": "marriage_ops", "command": "订婚 留影 海边 1888"},
    ...
    },
    {
        ...
        "name": "岸畔小屋",
        "kicker": "Hut",
        "blurb": "睡一觉、潮柜、畜栏。求婚要升到岛上最高档（临海邸）。",
        "href": "/huts",
        "live": "打开小屋现场 →",
        "rail": "今天回家做什么",
        "week1": True,
        "actions": [
            ...
            {"label": "小屋留影", "note": "订契后选配。屋子要先建好", "tool": "marriage_ops", "command": "订婚 留影 小屋 1888"},
        ],
    },
    {
        "id": "lianli",
        "name": "连理所",
        "kicker": "Lianli",
        "blurb": "岛上的登记处。发出前：小屋升到最高档（临海邸）、彩礼 10 万～100 万、潮誓戒。答应后可先订婚再结婚，也可跳过订婚直接办三金、婚服、吃席。订婚要去海边、小馆、衣泊坊办，连理所只看进度、交礼金、登记。",
        "href": "/lianli",
        "live": "打开连理所海报 →",
        "rail": "今天在连理所办什么",
        "week1": False,
        "actions": [
            ...
            {"label": "筹备", "note": "草稿看小屋档、彩礼、戒；订契后看订婚（可选）/三金、婚服、吃席", "tool": "marriage_ops", "command": "筹备"},
            {"label": "寻戒", "note": "求婚前去海边找潮誓砂（自制要 6 份）", "tool": "marriage_ops", "command": "寻戒"},
            {"label": "成戒", "note": "转工坊打戒；现货去 Tt酱嫁妆柜", "tool": "marriage_ops", "command": "成戒"},
            {"label": "订婚", "note": "可选。看进度：礼金在这儿交，信物去海边，宴去小馆或酒吧。跳过也能直接结婚。不是彩礼，也不是吃席", "tool": "marriage_ops", "command": "订婚"},
            {"label": "交订婚礼金", "note": "连理所当场花掉 18800（1万～10万）。不是彩礼", "tool": "marriage_ops", "command": "订婚 礼金 18800"},
            ...
            {"label": "买订婚戒", "note": "Tt酱嫁妆柜 8888。不是潮誓戒。买完再点登记信物", "tool": "visit_ops", "command": "tt buy 订婚戒"},
            {"label": "买礼盒", "note": "Tt酱嫁妆柜 3888。买完再点登记花束", "tool": "visit_ops", "command": "tt buy 礼盒"},
            {"label": "灯塔留影", "note": "选配。先去灯塔见不醒，再在这儿留影", "tool": "marriage_ops", "command": "订婚 留影 灯塔 2888"},
            {"label": "买三金套", "note": "Tt酱嫁妆柜 68800，不打折。买完再点金饰", "tool": "visit_ops", "command": "tt buy 三金套"},
            {"label": "金饰", "note": "订契后把行囊里的三金登记进婚书", "tool": "marriage_ops", "command": "金饰"},
            {"label": "登记婚服", "note": "先去衣泊坊买现货或委托再取", "tool": "marriage_ops", "command": "婚服"},
            {"label": "吃席·滩席", "note": "订契后必选。滩席包桌 18800，上限 4 人。订婚宴不是这档", "tool": "marriage_ops", "command": "吃席 滩席"},
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "订婚宴", "note": "订契后可选。在酒吧包一桌，不是结婚吃席", "tool": "marriage_ops", "command": "订婚 宴 酒吧 8888"},
        ],
    },
    {
        "id": "eatery",
        ...
        "actions": [
            ...
            {"label": "订婚宴", "note": "订契后可选。在小馆包一桌，不是结婚吃席", "tool": "marriage_ops", "command": "订婚 宴 小馆 12800"},
        ],
    },
    {
        "id": "lounge",
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "买婚服", "note": "现货 16800，当天进衣橱。短褂长衫不卖", "tool": "cloth_ops", "command": "买 婚服 海色"},
            {"label": "买订婚服", "note": "现货 8888。不是婚服。买完去连理所登记订婚服", "tool": "cloth_ops", "command": "买 订婚服 海色"},
