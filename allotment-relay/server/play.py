...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "桥桥诊所",
        "kicker": "Clinic",
        "blurb": "地上的病来这里。没病但身子虚也能调理，价贵。井下伤归晏安，桥桥不接。",
        "rail": "今天来诊所做什么",
        "week1": False,
        "actions": [
            ...
            {"label": "调理", "note": "没病也能补身子。看价目，贵", "tool": "visit_ops", "command": "clinic 调理"},
            {"label": "小补", "note": "88 票回 8 健康", "tool": "visit_ops", "command": "clinic 调理 小"},
            {"label": "中补", "note": "180 票回 14 健康", "tool": "visit_ops", "command": "clinic 调理 中"},
            {"label": "大补", "note": "360 票回 22 健康。专宰有余票的人", "tool": "visit_ops", "command": "clinic 调理 大"},
            {"label": "药架", "note": "可囤的药，含养命汤/丹/回春散", "tool": "visit_ops", "command": "clinic catalog"},
