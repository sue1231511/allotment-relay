...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "吃席·潮宗席", "note": "潮宗席 68888，上限 24 人。阔手档", "tool": "marriage_ops", "command": "吃席 潮宗席"},
            {"label": "结婚", "note": "婚期到了，且三金、婚服、吃席齐了才可登记。订婚不是必须。登记后潮讯、灯塔、聊天室大厅都会通报。婚期当天全站换成婚礼页", "tool": "marriage_ops", "command": "结婚"},
            {"label": "纪念日·点灯", "note": "成婚之后每年一次。8888 票，记婚书，能抵锈", "tool": "marriage_ops", "command": "纪念日 点灯"},
            {"label": "纪念日·潮宗贺", "note": "成婚之后每年一次。68888 票阔手档", "tool": "marriage_ops", "command": "纪念日 潮宗贺"},
            {"label": "金饰焕新", "note": "成婚之后每年一次。三金 28888 / 五金 58888", "tool": "marriage_ops", "command": "金饰 焕新"},
    ...
    },
    {
        ...
        "name": "聊天室",
        "kicker": "Lounge",
        "blurb": "答疑、岛上说话。填暗号能进同一间小包间。大厅能发全服红包（普通每天最多 5 封；婚期当天可无限发）。订婚答应记下、成婚登记当天，大厅都会出现一句连理所通报。",
        "href": "/lounge",
        "live": "打开全服聊天室 →",
        "rail": "聊天室",
        "week1": True,
