...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "连理所",
        "kicker": "Lianli",
        "blurb": "岛上的登记处。发出前：小屋升到最高档（临海邸）、彩礼 10 万～100 万、潮誓戒。答应后可先订婚再结婚，也可跳过订婚直接办三金、婚服、吃席。",
        "href": "/lianli",
        "live": "打开连理所海报 →",
        "rail": "今天在连理所办什么",
        "week1": False,
        "actions": [
            ...
            {"label": "订婚", "note": "可选。订契后办一场：礼金/信物/宴/花束必填，服装和留影选配。跳过也能直接结婚。不是彩礼，也不是吃席", "tool": "marriage_ops", "command": "订婚"},
    ...
    },
    {
        ...
        "name": "衣泊坊",
        "kicker": "Atelier",
        "blurb": "剧院侧厅。日常不卖成衣，只接裁衣委托。婚服有一挂现货。",
        "href": "/atelier",
        "live": "打开衣泊坊海报 →",
        "rail": "今天把什么布交给她",
        "week1": False,
