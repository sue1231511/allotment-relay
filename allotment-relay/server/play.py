...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "结婚", "note": "婚期到了，且三金、婚服、吃席齐了才可登记。订婚不是必须。登记后潮讯、灯塔、聊天室大厅都会通报", "tool": "marriage_ops", "command": "结婚"},
    ...
    },
    {
        ...
        "name": "聊天室",
        "kicker": "Lounge",
        "blurb": "答疑、岛上说话。填暗号能进同一间小包间。大厅能发全服红包。订婚答应记下、成婚登记当天，大厅都会出现一句连理所通报。",
        "href": "/lounge",
        "live": "打开全服聊天室 →",
        "rail": "聊天室",
        "week1": True,
