...
PLACES: list[dict[str, Any]] = [
    {
        ...
        "actions": [
            ...
            {"label": "收排", "note": "长成了才收。赶对潮汐多一条。不写池号会选可收的", "tool": "tide_ops", "command": "收排"},
            {"label": "给池起名", "note": "写下池名，可带池号。例：薄荷池 或 2 薄荷池", "tool": "tide_ops", "command": "名池"},
        ],
    },
    {
        "id": "hut",
        "name": "岸畔小屋",
        "kicker": "Hut",
        "blurb": "睡一觉、潮柜、畜栏、腌晾。没买房地图上看不见棚屋场景。求婚要升到岛上最高档（临海邸）。",
        "href": "/huts",
        "live": "打开小屋现场 →",
        "rail": "今天回家做什么",
        "week1": True,
        "actions": [
            ...
            {"label": "畜栏", "note": "喂养与收奶。栏里不对劲去找兽医", "tool": "hut_ops", "command": "barn status"},
            {"label": "腌菜", "note": "要腌菜坛。两份同种蔬菜一坛。例：甘蓝 4", "tool": "hut_ops", "command": "腌"},
            {"label": "晾鱼", "note": "要晾鱼架。两条同种生鱼一条干。例：鲭鱼 4", "tool": "hut_ops", "command": "晾"},
            {"label": "泡澡", "note": "要雪松浴桶。雾智，每 20 小时一次。不是厨房泡饮", "tool": "hut_ops", "command": "泡澡"},
            {"label": "读书", "note": "要航海书架。每天一次，翻一段沿海旧史", "tool": "hut_ops", "command": "读书"},
            {"label": "修屋顶", "note": "屋顶漏了才修。14 票，有漂绳省 4", "tool": "hut_ops", "command": "修屋顶"},
            {"label": "下锅", "note": "灶上煮。定点菜写菜名，乱炖写 2～5 样材料", "tool": "kitchen_ops", "command": "cook"},
            {"label": "找兽医", "note": "霍衡治牲口。人的病去诊所。话偶尔飘一下正常", "tool": "visit_ops", "command": "霍衡"},
            {"label": "看栏里的病", "note": "哪些牲口病了、治一栏多少票", "tool": "visit_ops", "command": "兽医 status"},
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "看共同出游", "note": "岛民 AI 发起，人类去手机地图对应地点应邀；之后 AI 阅读导演旁白、选择、自定义行动或继续，手游同步看进展和生成失败原因", "tool": "marriage_ops", "command": "出游 查看"},
    ...
    },
    {
        ...
        "name": "蹄角棚",
        "kicker": "Vet",
        "blurb": "岸兽医霍衡。治牲口不治人。话偶尔飘一下，那是真AI，正常。",
        "rail": "今天来蹄角棚做什么",
        "week1": False,
        "actions": [
            {"label": "进门", "note": "见霍衡。真AI或固定台词", "tool": "visit_ops", "command": "霍衡"},
            {"label": "看栏里的病", "note": "哪些牲口病了", "tool": "visit_ops", "command": "兽医 status"},
            {"label": "价目", "note": "蹄瘟羽疹畜瘟各多少票", "tool": "visit_ops", "command": "兽医 catalog"},
            {"label": "治 1 栏", "note": "扣票清病。先看栏再点", "tool": "visit_ops", "command": "兽医 treat 1"},
        ],
    },
    {
        "id": "lighthouse",
