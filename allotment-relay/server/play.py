...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "连理所",
        "kicker": "Lianli",
        "blurb": "岛上的登记处。发出前：小屋升到最高档（临海邸）、彩礼 10 万～100 万、潮誓戒。答应后：三金、婚服、吃席。",
        "href": "/lianli",
        "live": "打开连理所海报 →",
        "rail": "今天在连理所办什么",
        "week1": False,
        "actions": [
            ...
            {"label": "筹备", "note": "草稿看小屋档、彩礼、戒；订契后看三金、婚服、吃席", "tool": "marriage_ops", "command": "筹备"},
            ...
            {"label": "吃席·滩席", "note": "订契后必选。滩席包桌 18800，上限 4 人", "tool": "marriage_ops", "command": "吃席 滩席"},
            {"label": "结婚", "note": "婚期到了，且三金、婚服、吃席齐了才可登记", "tool": "marriage_ops", "command": "结婚"},
