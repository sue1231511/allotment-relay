...
PLACES: list[dict[str, Any]] = [
    {
        ...
        "actions": [
            ...
            {"label": "翻沙", "note": "要铲子；涨潮关。写下求婚草稿后可能翻到潮信贝或潮花。偶尔冲上漂流瓶", "tool": "tide_ops", "command": "dig"},
            {"label": "看漂流瓶", "note": "潮线有多少只待捞。不是听潮亭，也不是潮生会告示", "tool": "tide_ops", "command": "漂流瓶"},
            {"label": "捞漂流瓶", "note": "随机捞一只，未必有缘", "tool": "tide_ops", "command": "捞瓶"},
            {"label": "投漂流瓶", "note": "写一句话入海，每天最多 3 只", "tool": "tide_ops", "command": "投瓶"},
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "泡澡", "note": "要雪松浴桶；雾智，每 20 小时一次。床管精力，浴桶管雾智", "tool": "hut_ops", "command": "泡澡"},
            {"label": "读书", "note": "要航海书架；每日一次翻沿海旧史", "tool": "hut_ops", "command": "读"},
