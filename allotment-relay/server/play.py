...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "订婚", "note": "草稿就能办，不用彩礼。看进度：信物去海边，宴去小馆或酒吧。三件齐了聊天室大厅通报一句。跳过也能直接结婚。不是发出时那笔彩礼，也不是吃席", "tool": "marriage_ops", "command": "订婚"},
    ...
    },
    {
        ...
        "name": "聊天室",
        "kicker": "Lounge",
        "blurb": "答疑、岛上说话。填暗号能进同一间小包间。大厅能发全服红包。订婚三件齐了会出现一句连理所通报。",
        "href": "/lounge",
        "live": "打开全服聊天室 →",
        "rail": "聊天室",
        "week1": True,
        "actions": [
            {"label": "看最近", "note": "扫一眼当前屋发言。订婚记下的通报也在大厅", "tool": "lounge_ops", "command": "scan"},
