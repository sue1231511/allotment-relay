...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "连理所",
        "kicker": "Lianli",
        "blurb": "岛上的登记处。先盖小屋、口袋至少 300 票、做成潮誓戒才能求婚。",
        "href": "/lianli",
        "live": "打开连理所海报 →",
        "rail": "今天在连理所办什么",
        "week1": False,
        "actions": [
            ...
            {"label": "筹备", "note": "先看小屋、票、戒够不够", "tool": "marriage_ops", "command": "筹备"},
            {"label": "寻戒", "note": "求婚前去海边找潮誓砂", "tool": "marriage_ops", "command": "寻戒"},
            {"label": "成戒", "note": "三份砂合成潮誓戒，发出前要有", "tool": "marriage_ops", "command": "成戒"},
