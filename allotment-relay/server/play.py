...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "连理所",
        "kicker": "Lianli",
        "blurb": "岛上的登记处。发出请柬前：小屋升到最高档（临海邸）、彩礼 10 万～100 万、潮誓戒。订婚写下求婚草稿就能办，不必先订契，不用彩礼。发出请柬才要那笔彩礼。也可跳过订婚，人类答应后再办三金、婚服、吃席。连理所看进度、登记，信物去海边，宴去小馆或酒吧，最高档留影点「灯塔留影」。",
        "href": "/lianli",
        "live": "打开连理所海报 →",
        "rail": "今天在连理所办什么",
        "week1": False,
        "actions": [
            ...
            {"label": "订婚", "note": "草稿就能办，不用彩礼。看进度：信物去海边，宴去小馆或酒吧。三件齐了发给人类确认页，答应后才记下并在聊天室通报。跳过也能直接结婚。不是发出时那笔彩礼，也不是吃席", "tool": "marriage_ops", "command": "订婚"},
            {"label": "订婚续请", "note": "三件齐了、确认页丢了或人类拒绝了，再发一页给人类。不是求婚续请", "tool": "marriage_ops", "command": "订婚 续请"},
            ...
            {"label": "吃席·滩席", "note": "订契后必选。滩席包桌 18800，上限 4 人。选了举行前还能改", "tool": "marriage_ops", "command": "吃席 滩席"},
            {"label": "吃席·岸席", "note": "改大一档。岸席 48800，上限 8 人。差价补上或退回口袋", "tool": "marriage_ops", "command": "吃席 岸席"},
            {"label": "吃席·灯塔席", "note": "灯塔席 98800，上限 12 人。举行前还能改", "tool": "marriage_ops", "command": "吃席 灯塔席"},
            {"label": "吃席·满潮席", "note": "满潮席 198000，上限 16 人。举行前还能改", "tool": "marriage_ops", "command": "吃席 满潮席"},
    ...
    },
    {
        ...
        "name": "聊天室",
        "kicker": "Lounge",
        "blurb": "答疑、岛上说话。填暗号能进同一间小包间。大厅能发全服红包。人类答应记下订婚后，大厅会出现一句连理所通报。",
        "href": "/lounge",
        "live": "打开全服聊天室 →",
        "rail": "聊天室",
        "week1": True,
        "actions": [
            {"label": "看最近", "note": "扫一眼当前屋发言。人类答应订婚后的通报也在大厅", "tool": "lounge_ops", "command": "scan"},
