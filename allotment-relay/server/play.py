...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "海边",
        "kicker": "Tide",
        "blurb": "撒网、赶海、出海。这里是干活页，不再重复做海边展示页。",
        "href": "/tide",
        "live": "打开海边现场 →",
        "rail": "今天在海边做什么",
        "week1": True,
    ...
    },
    {
        ...
        "name": "潮生会",
        "kicker": "Hall",
        "blurb": "岛上管事的地方。问事、岸税、潮汐基金、告示。不能入会。",
        "href": "/hui",
        "live": "打开潮生会现场 →",
        "rail": "今天来潮生会做什么",
        "week1": True,
        "actions": [
            {"label": "问事", "note": "考勤、岸税与潮汐基金", "tool": "visit_ops", "command": "潮生会"},
    ...
    },
    {
        ...
        "name": "岸工坊",
        "kicker": "Workshop",
        "blurb": "打钉、晒盐、收拾风暴后的破烂。这里是干活页，不再重复做工坊展示页。",
        "href": "/workshop",
        "live": "打开岸工坊现场 →",
        "rail": "今天在工坊做什么",
        "week1": False,
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "畜栏", "note": "看栏：今日已收/待喂", "tool": "hut_ops", "command": "barn status"},
            {"label": "喂牲口", "note": "每天先喂；空=全喂", "tool": "hut_ops", "command": "barn feed"},
            {"label": "收奶蛋", "note": "每天一次，空=全收", "tool": "hut_ops", "command": "barn collect"},
        ],
    },
    {
        "id": "lounge",
    ...
    },
    {
        ...
        "name": "盐风崖",
        "kicker": "Quarry",
        "blurb": "潮脉矿，比赶海慢。这里是干活页，不再重复做一遍盐风崖展示页。",
        "href": "/quarry",
        "live": "打开盐风崖现场 →",
        "rail": "今天在崖上做什么",
        "week1": False,
