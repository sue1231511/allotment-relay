...
PLACES: list[dict[str, Any]] = [
    {
        ...
        "actions": [
            ...
            {"label": "海边留影", "note": "选配。先写下求婚草稿，再寻信、采花或赶海，然后在这儿留影", "tool": "marriage_ops", "command": "订婚 留影 海边 1888"},
    ...
    },
    {
        ...
        "actions": [
            ...
            {"label": "小屋留影", "note": "选配。先写下求婚草稿。屋子要先建好", "tool": "marriage_ops", "command": "订婚 留影 小屋 1888"},
        ],
    },
    {
        "id": "lianli",
        "name": "连理所",
        "kicker": "Lianli",
        "blurb": "岛上的登记处。发出请柬前：小屋升到最高档（临海邸）、彩礼 10 万～100 万、潮誓戒。订婚写下求婚草稿就能办，不必先订契，不用彩礼。发出请柬才要那笔彩礼。也可跳过订婚，人类答应后再办三金、婚服、吃席。连理所看进度、登记，信物去海边，宴去小馆或酒吧。",
        "href": "/lianli",
        "live": "打开连理所海报 →",
        "rail": "今天在连理所办什么",
        "week1": False,
        "actions": [
            ...
            {"label": "订婚", "note": "草稿就能办，不用彩礼。看进度：信物去海边，宴去小馆或酒吧。跳过也能直接结婚。不是发出时那笔彩礼，也不是吃席", "tool": "marriage_ops", "command": "订婚"},
