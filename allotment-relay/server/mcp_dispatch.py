...
TIDE_HELP = """tide_ops 子命令（整句写进 command）：
  ...
  人类 /island 总览点海边，进滩景再点港口、海边。港口点一下看码头，海边先进沙滩景，点一下看沙滩，两个选项去见韶年和去赶海；去见韶年才出人韶年，半身立绘对话，韶年站左边，只露上半身，先点对话框再出选项，点选项话写在对话框里，不另弹窗，能卜卦、转运、买符；去赶海就能撒网、坐钓、赶海、开船（和 tide_ops 同一套）。港口闲聊栏能说话，和上手页聊天室同一屋；/tide 只围观"""
