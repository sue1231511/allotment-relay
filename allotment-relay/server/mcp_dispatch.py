...
TIDE_HELP = """tide_ops 子命令（整句写进 command）：
  ...
  beach scan|dig|probe — 赶海（dig 要铲子）。涨潮时 dig 和 probe 都关，scan 还能看。dig 偶发铲钝、probe 偶发沙坍：下次多 2 精力（各记一次消一次）。dig 不是崖矿，矿石走 quarry_ops 挖。风暴打捞不是 dig，走 craft_ops 打捞
...
VISIT_HELP = """visit_ops 子命令（整句写进 command）：
  ...
  服务 / 收费服务 — 方案点名全表。修船/修屋/修镐/修钓竿/兽医/鱼拓/花束/婚礼布置只指路；磨刀、鱼处理、土壤检测、动物清洁、家具翻新/搬运当场办。例子：visit_ops 服务 · 服务 磨刀 · 服务 鱼处理 �新/搬运当场办。例子：visit_ops 服务 · 服务 磨刀 · 服务 鱼处理 鲭鱼 · 服务 动物清洁 1
