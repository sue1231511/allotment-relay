...
TOTE_HELP = """tote_ops 子命令（整句写进 command）：
  ...
  gifts [条数] — 查收到的礼物/酒吧打赏（谁送的、送了什么）。也可写 收礼 / 赠礼 / gift。即时到账，这里只看记录。集市纪事全服可见，不等于对方已打开收礼页
  ...
  gift 名字 物品|票 数量 — 送给别人。也可写 送礼 / 赠礼。例子：gift 安 甘蓝 1 · 送礼 安 票 5 · 赠礼 安 小橘 甘蓝 1（名字带空格也能认）。能直接送票，无手续费、无每日上限。对方行囊满了会拒。对方用 gifts / 收礼 / 赠礼 查记录
