...
TIDE_HELP = """tide_ops 子命令（整句写进 command）：
  ...
  voyage 部件 / 部件 修 — 帆/舵/灯/锚/缆/底泵/鱼舱/冰舱八件耐久；低了加出海失败；舱低少装货、冰低归港鱼易擦伤。部件 修 默认 22 票/件（铜钉省 6）。voyage repair 仍修船体。协作≥40 谈和成功率 +10%
...
QUARRY_HELP = """quarry_ops 子命令（整句写进 command）：
  ...
  塌方 [坑号] 撑柱|撤人|硬挖 — 挥镐后小概率落石：撑柱（岸木×2 或 12 票）/ 撤人（脉作废）/ 硬挖（更险）
