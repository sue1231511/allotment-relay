...
VISIT_HELP = """visit_ops 子命令（整句写进 command）：
  ...
  buxing visit|tea|tide|light 给谁 | 求什么|gallery|entrust 旧事|watch|remember|fulfill 灯号 — 守灯人·不醒；茶每日一次，问潮前 5 次免费，灯廊公开。人类 /island 广场点灯塔是半身立绘对话，不醒站左边，选项和对话分开，上手页「灯塔」也能点
