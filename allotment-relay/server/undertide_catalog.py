...
# ── NPC 斗士（深坑）────────────────────────────────────────
# power 为战力底盘（等级梯度 30/45/60/78/100 ± 浮动）
PIT_FIGHTERS = [
    {"name": "新兵阿旺", "level": 1, "power": 30, "flavor": "第一次下坑，手一直在抖。但没退。"},
    {"name": "赔率小萨", "level": 1, "power": 33, "flavor": "输了七场还在打。所有人都押他输，他无所谓。"},
    {"name": "双港老雕", "level": 2, "power": 47, "flavor": "打完就去酒馆，喝完就来打。没有别的日程。"},
    {"name": "缝过三针的安", "level": 2, "power": 45, "flavor": "肚子上三道疤，缝得很漂亮。没人问是谁缝的。"},
    {"name": "老磨", "level": 3, "power": 61, "flavor": "三十七场。墙上有他的名字。他想凑个整数。"},
    {"name": "雨季来的女人", "level": 3, "power": 58, "flavor": "没人知道她从哪来。她打完就走，从不喝酒。"},
    {"name": "屠夫老甘", "level": 4, "power": 80, "flavor": "以前真的杀猪。手艺没丢。"},
    {"name": "墙上的名字", "level": 5, "power": 102, "flavor": "没人叫他真名。赢到第五级的人，名字就上墙了。"},
]
# 阵亡后自动补充的新人名池
PIT_REPLACEMENTS = [
