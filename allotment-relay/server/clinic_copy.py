...
CHAT_LINES = [
    ...
    "桥桥大夫：「羊蹄发黑别来我这儿排。西棚霍衡。人要是摸了病死牲口发烧，那才归我。」",
    "桥桥大夫：「赤潮网上来的疹，我治。栏里咳的，霍衡治。别搞混。」",
]
...
TREAT_LINES: dict[str, list[str]] = {
    ...
    "barn_fever": [
        "摸了病畜还来问我羊蹄怎么办？人的烧我压，牲口的病去霍衡。手伸出来。",
        "畜热。下次挤病奶先洗手。药给你，苦的。",
    ],
    "hoof_toxin": [
        "蹄毒。菌压着，约两次。别再伸手进病栏。",
        "红肿先压一档。蹄子的事先找霍衡，别把人的号和牲口的号排一块儿。",
    ],
    "murrain_touch": [
        "瘟触。接触了病死栏是吧。两次挂号，别逞强。栏里的事还是霍衡。",
        "发冷先压住。死畜不要再摸。人的药在这边，牲口的药在西棚。",
    ],
    "tide_rash": [
        "赤潮周还贪网？疹子给你药。下次海红了就吃菜。",
        "潮疹不是水母蛰。别去蹄角棚排队，霍衡不给人开药。",
    ],
    "malnutrition": [
