...
PULSE_SEASON_LORE: dict[str, list[str]] = {
    ...
    "weekly_tide": [
        "周潮：人类日历每周刮一次，低中高随机。3万以上才冲超额。",
        "姜姨：海不跟穷人过不去，跟把票堆过三万的人过不去。",
    ],
}
...
CLINIC_LORE = [
    ...
    "窗台斑鸠比病人好伺候——至少不还价。咕咕两声算打招呼。",
    "深坑抬上来的伤别往我这儿送：「井下打的？找晏安去。」",
    "凌晨来看诊加收五块。嫌贵回去躺着等天亮。——价目表边角小字",
]
...
NPC_STORY_LORE = [
    ...
    "《柜底的布》漾漾不卖成衣。侧厅那排柜子里，梅雨纱、盛夏葛、台风绸、冬潮呢按季收着；过季不是绝版，是等浪下一年再送回来。有人问她为什么不把衣服挂到门口，她说布还记得谁穿过，挂出去就成了别人的故事。",
]
