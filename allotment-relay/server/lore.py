...
PULSE_SEASON_LORE: dict[str, list[str]] = {
    ...
    "drought": [
        "干旱周：露天没浇水的地发僵，中高档可能枯。浇水能扛，温室不怕。周潮不因此扣票。",
        "井绳发紧那周，牲口没喂更容易渴垮。先浇地、再喂栏。",
    ],
    "heatwave": [
        "热浪周：比干旱更烤。没浇的菜、没喂的牲口、地里的人都遭罪。中暑找桥桥。",
        "日头罚站的日子，温室是岛上最凉快的地方。",
    ],
    "frost": [
        "霜冻周：热带露天发僵。甘蓝一类还行，菠萝木瓜别露天硬扛。",
        "白霜那周温室更值钱。海不冻，地冻。",
    ],
    "pest_wave": [
        "虫害潮：露天刚打理完，虫可能再来一遍。温室更省心。",
        "菜青虫不认档口，认露天叶子。",
    ],
    "warm_rain": [
        "回暖雨：露天地自己润一点，浇水更香。",
    ...
    "gale_crop": [
        "秋台扫过露天：没人看的地更容易出事。打理过的更稳。",
        "篱笆倒了先扶篱笆，再问菜。",
    ],
    "blossom_tide": [
        "花粉潮：花开得凶，鸡鸭羽疹、人打喷嚏，都是同一阵风。",
        "姜姨捂着鼻子：花好看，别拿鼻子去对。",
    ],
    "spring_flood": [
        "春汛：近岸鱼多，滩上湿。网沉下去那一下，心跳也跟着沉。",
        "春水满了，岸上人忙网，栏里人别忘喂。",
    ],
    "thunderstorm": [
        "雷暴周：露天发僵，出海不稳。棚里牲口会抖。",
        "雷先到，雨后到。先把栏门插上。",
    ],
    "leaf_fall": [
        "落叶潮：篱边好捡，别把病叶扫进畜栏。",
    ...
    "murrain_week": [
        "畜瘟潮：栏里容易传。不对劲去蹄角棚找霍衡，别去桥桥排队。",
        "霍衡：这不是人的病。拖着会病死，死了没肉。",
    ],
    "snowbound": [
        "雪封：露天发僵，栏里小心冻蹄。温室是岛上最暖和的地。",
        "雪把门封住的日子，先喂栏，再问海。",
    ],
    "north_wind": [
        "北风：出海发硬。空网不丢人，硬撑才丢人。",
...
BARTON_SEASON_NOTES: dict[str, list[str]] = {
    ...
    "drought": [
        "旱年别跟天赌。浇过的地还在，没浇的地会先走。",
        "井绳发紧时，牲口比人更先渴。",
    ],
    "heatwave": [
        "热浪里还下地，桥桥那边排队。中暑不丢人，丢人的是硬扛。",
        "日头比黑潮老实：它不认口袋，认你有没有浇水。",
    ],
    "frost": [
        "霜降那周热带作物别露天硬撑。温室不是摆设。",
        "白霜贴叶背的早晨，别急着收，先看茎还活不活。",
    ],
    "pest_wave": [
        "虫口翻倍的周，tend 过也得再看一眼。",
        "温室纱网那几天最值钱。",
    ...
    "gale_crop": [
        "秋台过境，没人看的地先倒。篱笆比苗值钱的时候到了。",
        "风大不可怕。觉得自己比风大才可怕。——田间版",
    ],
    "blossom_tide": [
        "花粉潮别拿鼻子去对花。鸡鸭先出事，人后打喷嚏。",
        "花开得凶的周，栏也要巡。",
    ],
    "spring_flood": [
        "春汛来了就下网。别全扔给酒吧。",
...
NPC_STORY_LORE = [
    ...
    "《蹄角棚》霍衡年轻时跟北岸商船看驮畜。二十年前那一场畜瘟，他没赶上第一夜，只赶上清栏。后来在岛西搭了蹄角棚：碘酒、蹄刀、不赊账。桥桥诊所在东头治人，他在西棚治牲口。人发烧他往东指；羊咳了她往西指。棚里后来接了外线，他说话偶尔会飘一下——岛民当那是真的，偶尔波动，正常。",
]
