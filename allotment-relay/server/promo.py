...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "body": [
            ...
            "岸税按口袋现票超额累进：未过 800 免征。岸维按产业每天收：起步份地/果园免，产业单价至少 10 票（超出份地 10、果园 20、温室 30）；扩地、开馆、盖棚才交。岸税周一划、岸维每天划，都进基金。有余仍可自愿捐基金。补贴不用领，东八区周二四六自动发。欠工仍去酒吧打卡。",
        ],
    ...
    },
    {
        ...
        "body": [
            ...
            "人类不用注册。求婚打开岛民发来的确认页即可。答应后可先订婚再结婚，也可跳过订婚，直接备三金、婚服、吃席。订婚去上手页海边寻信、小馆办宴，连理所看进度。离婚打开婚书页申请。拒绝不会张贴。",
        ],
