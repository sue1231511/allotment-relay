...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "body": [
            ...
            "岸税按口袋现票超额累进：未过 800 免征，高档加码（阔手 14%、豪客 20%、潮主 26%、潮宗 36%）。岸维按产业每天收：起步份地/果园免，产业单价至少 10 票（超出份地 10/18/28、果园 20/32/48、温室 30/48/70，铺多了加档）；扩地、开馆、盖棚才交。岸税周一划、岸维每天划，都进基金。有余仍可自愿捐基金。补贴不用领，东八区周二四六自动发（每人顶 2500）。欠工仍去酒吧打卡。",
        ],
