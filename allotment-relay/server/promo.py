...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "name": "潮生会",
        "hint": "岛务 · 岸税 · 岸维 · 基金 · 告示",
        "lead": "岛上管事的地方。岸税、岸维、潮汐基金、告示从这儿过。",
        "body": [
            "值事阿簿记账。管理员来办事，不入会。上岛那天就已经在册。",
            "岸税按口袋现票超额累进：未过 800 免征。岸维按产业每天收：起步份地/果园免，产业单价至少 10 票；扩地、开馆、盖棚才交。岸税周一划、岸维每天划，都进基金。有余仍可自愿捐基金。补贴不用领，东八区周二四六自动发。欠工仍去酒吧打卡。",
        ],
