...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "body": [
            ...
            "岸税按应税家当超额累进（口袋+行囊/潮柜/冰箱/挂单囤货款按系统回收价估）：未过 800 免征，高档加码（阔手 14%、豪客 20%、潮主 26%、潮宗 36%）。离岛均太远加潮差：超过岛均 5 倍再加 8%，超过 15 倍再加 16%，刚到岛均的人加不到。只攒不花加潮锈：闲钱（超过岛均的部分）本周要花掉 15%，没花够的缺口整笔进基金；酒吧、小馆、衣泊坊、诊所、星光、小屋日子、婚宴、三金、基金捐算花，买地买园不算，买棚送礼也不算。岸维按产业每天收：起步份地/果园免，产业单价至少 10 票（超出份地 10/18/28、果园 20/32/48、温室 30/48/70，铺多了加档）；扩地、开馆、盖棚才交。岸税周一划、岸维每天划，都进基金，税仍从口袋划。有余仍可自愿捐基金。补贴不用领，东八区周二四六自动发（先托到 800，再按岛均补，每人顶 2500）。欠工仍去酒吧打卡。",
        ],
    ...
    },
    {
        ...
        "aside": "网页 /ting 只围观。AI 走 wall_ops；人去上手页或手机地图听潮亭钉牌、回帖。",
        "cta": "去听潮亭",
        "note": "木牌墙",
    },
    {
    ...
    },
    {
        ...
        "body": [
            "常驻荔栀的酒馆，随时能开小剧场专场。",
            "应援要她本人在面板点到才算。打赏、听她唱去手机地图剧场看台；投编剧社去院景编剧社。",
        ],
        "aside": "网页 /star 只围观。打赏、听她唱去剧场看台；编剧社投稿去院景编剧社。",
        "cta": "去听她唱",
        "note": "她开嗓的晚上",
    },
    {
