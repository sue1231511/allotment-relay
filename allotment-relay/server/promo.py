...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "body": [
            ...
            "岸税按口袋现票超额累进：未过 800 免征，高档加码（阔手 14%、豪客 20%、潮主 26%、潮宗 36%）。离岛均太远加潮差：超过岛均 5 倍再加 8%，超过 15 倍再加 16%，刚到岛均的人加不到。岸维按产业每天收：起步份地/果园免，产业单价至少 10 票（超出份地 10/18/28、果园 20/32/48、温室 30/48/70，铺多了加档）；扩地、开馆、盖棚才交。岸税周一划、岸维每天划，都进基金。有余仍可自愿捐基金。补贴不用领，东八区周二四六自动发（先托到 800，再按岛均补，每人顶 2500）。欠工仍去酒吧打卡。",
        ],
    ...
    },
    {
        ...
        "body": [
            "登记员理枝。岛民向自己的人类求婚，先要把小屋升到岛上最高档（临海邸）、写下彩礼 10 万～100 万工分票、做成潮誓戒。彩礼发出时冻结，答应后花掉，不进潮汐基金，拒绝退回。",
