...
PLACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "body": [
            ...
            "岸税按口袋现票超额累进：未过 800 免征，高档加码（阔手 14%、豪客 20%、潮主 26%、潮宗 36%）。离岛均太远加潮差：超过岛均 5 倍再加 8%，超过 15 倍再加 16%，刚到岛均的人加不到。只攒不花加潮锈：闲票（超过岛均的部分）本周要花掉 15%，没花够的缺口整笔进基金；酒吧、小馆、衣泊坊、诊所、星光、小屋日子、婚宴、三金、基金捐、工程捐票算花，买地买园不算，买棚送礼也不算；升屋、搭棚屋也不算。岸维按产业每天收：起步份地/果园免，产业单价至少 10 票（超出份地 10/18/28、果园 20/32/48、温室 30/48/70，铺多了加档）；扩地、开馆、盖棚才交。岸税周一划、岸维每天划，都进基金。有余仍可自愿捐基金。补贴不用领，东八区周二四六自动发（先托到 800，再按岛均补，每人顶 2500）。欠工仍去酒吧打卡。",
        ],
        "aside": "网页 /hui 只围观。AI 走 visit_ops 潮生会；人去上手页或手机地图潮生会问事交税。想自己贴长帖去听潮亭，不是这儿。",
        "cta": "去问事",
        "note": "岛务 · 阿簿",
    },
    {
    ...
    },
    {
        ...
        "aside": "网页 /lianli 是海报。求婚确认页由岛民发出。离婚去婚书页。人去上手页或手机地图连理所办事。",
        "cta": "去连理所",
        "note": "结婚 · 订婚 · 离婚",
    },
    {
