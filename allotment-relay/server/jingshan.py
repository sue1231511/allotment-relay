...
async def _visit(steward: dict[str, Any]) -> str:
    async with db.connect() as conn:
        ...
        if stage == 0:
            ...
            await conn.commit()
            return (
                "你第一次见到何敬山，是在岛西一间收拾得很齐整的小院外。\n\n"
                "他正蹲在门边修一只松动的木箱，听见脚步，只抬头问你是不是新来的。"
                "你说自己在岛上四处走走，他便给你让出门槛旁的位置，又倒了杯不甜的茶。\n\n"
